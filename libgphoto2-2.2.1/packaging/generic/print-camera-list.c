...
#define GP_CAMERA_GROUP	"plugdev"
...
udev_begin_func (const func_params_t *params)
{
	...
	printf ("SUBSYSTEM==\"usb_device\", GOTO=\"libgphoto2_rules_real\"\n");
	printf ("SUBSYSTEM==\"usb\", GOTO=\"libgphoto2_rules_real\"\n");
	printf ("BUS!=\"usb\", GOTO=\"libgphoto2_rules_end\"\n\n");
	printf ("LABEL=\"libgphoto2_rules_real\"\n\n");
...
static const output_format_t formats[] = {
	...
	{name: "usb-usermap",
	 ...
	 help: "If no <scriptname> is given, chmod 0660 and chrgrp to "
