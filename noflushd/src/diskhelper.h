 ...
 * 
 * $Id: diskhelper.h,v 1.1.1.1 2010-09-21 01:09:51 jmaggard Exp $
 *
 */
 ...
 * Changed to add MTD devices, hd[ab], and SCSI so we ignore them too.
 */
#ifdef __sparc__
#define IS_META(major,minor)	\
		(((major) == MD_MAJOR || (major) == LVM_BLK_MAJOR || \
		  (major) == MTD_MAJOR || (major) == SCSI_DISK0_MAJOR || \
		  (major) == IDE0_MAJOR || (major) == DM_BLK_MAJOR ))
#elif __arm__
#define IS_META(major,minor)	\
		(((major) == MD_MAJOR || (major) == LVM_BLK_MAJOR || \
