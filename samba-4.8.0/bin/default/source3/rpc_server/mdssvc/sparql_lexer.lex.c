#line 2 "default/source3/rpc_server/mdssvc/sparql_lexer.lex.c"

#line 4 "default/source3/rpc_server/mdssvc/sparql_lexer.lex.c"
...
char *mdsyytext;
#line 1 "../source3/rpc_server/mdssvc/sparql_lexer.l"
/*
...
*/
#line 22 "../source3/rpc_server/mdssvc/sparql_lexer.l"
#include "includes.h"
...
#line 549 "default/source3/rpc_server/mdssvc/sparql_lexer.lex.c"
...
void mdsyyset_in  (FILE * in_str  );

FILE *mdsyyget_out (void );

void mdsyyset_out  (FILE * out_str  );
...
void mdsyyset_lineno (int line_number  );
...
#define YY_INPUT(buf,result,max_size) \
	if ( YY_CURRENT_BUFFER_LVALUE->yy_is_interactive ) \
		...
		{ \
		errno=0; \
		while ( (result = fread(buf, 1, (yy_size_t) max_size, mdsyyin)) == 0 && ferror(mdsyyin)) \
			{ \
			if( errno != EINTR) \
				{ \
				YY_FATAL_ERROR( "input in flex scanner failed" ); \
...
YY_DECL
{
	...
	{
#line 41 "../source3/rpc_server/mdssvc/sparql_lexer.l"

#line 763 "default/source3/rpc_server/mdssvc/sparql_lexer.lex.c"
...
case 1:
YY_RULE_SETUP
#line 42 "../source3/rpc_server/mdssvc/sparql_lexer.l"
return FUNC_INRANGE;
	YY_BREAK
case 2:
YY_RULE_SETUP
#line 43 "../source3/rpc_server/mdssvc/sparql_lexer.l"
return DATE_ISO;
	YY_BREAK
case 3:
YY_RULE_SETUP
#line 44 "../source3/rpc_server/mdssvc/sparql_lexer.l"
{mdsyylval.bval = false; return BOOL;}
	YY_BREAK
case 4:
YY_RULE_SETUP
#line 45 "../source3/rpc_server/mdssvc/sparql_lexer.l"
{mdsyylval.bval = true; return BOOL;}
	YY_BREAK
case 5:
YY_RULE_SETUP
#line 46 "../source3/rpc_server/mdssvc/sparql_lexer.l"
return QUOTE;
	YY_BREAK
case 6:
YY_RULE_SETUP
#line 47 "../source3/rpc_server/mdssvc/sparql_lexer.l"
return OBRACE;
	YY_BREAK
case 7:
YY_RULE_SETUP
#line 48 "../source3/rpc_server/mdssvc/sparql_lexer.l"
return CBRACE;
	YY_BREAK
case 8:
YY_RULE_SETUP
#line 49 "../source3/rpc_server/mdssvc/sparql_lexer.l"
return AND;
	YY_BREAK
case 9:
YY_RULE_SETUP
#line 50 "../source3/rpc_server/mdssvc/sparql_lexer.l"
return OR;
	YY_BREAK
case 10:
YY_RULE_SETUP
#line 51 "../source3/rpc_server/mdssvc/sparql_lexer.l"
return EQUAL;
	YY_BREAK
case 11:
YY_RULE_SETUP
#line 52 "../source3/rpc_server/mdssvc/sparql_lexer.l"
return UNEQUAL;
	YY_BREAK
case 12:
YY_RULE_SETUP
#line 53 "../source3/rpc_server/mdssvc/sparql_lexer.l"
return EQUAL;
	YY_BREAK
case 13:
YY_RULE_SETUP
#line 54 "../source3/rpc_server/mdssvc/sparql_lexer.l"
return LT;
	YY_BREAK
case 14:
YY_RULE_SETUP
#line 55 "../source3/rpc_server/mdssvc/sparql_lexer.l"
return GT;
	YY_BREAK
case 15:
YY_RULE_SETUP
#line 56 "../source3/rpc_server/mdssvc/sparql_lexer.l"
return COMMA;
	YY_BREAK
case 16:
YY_RULE_SETUP
#line 57 "../source3/rpc_server/mdssvc/sparql_lexer.l"
{mdsyylval.sval = talloc_strdup(talloc_tos(), mdsyytext); return WORD;}
	YY_BREAK
case 17:
/* rule 17 can match eol */
YY_RULE_SETUP
#line 58 "../source3/rpc_server/mdssvc/sparql_lexer.l"
/* ignore */
	YY_BREAK
case 18:
YY_RULE_SETUP
#line 59 "../source3/rpc_server/mdssvc/sparql_lexer.l"
ECHO;
	YY_BREAK
#line 911 "default/source3/rpc_server/mdssvc/sparql_lexer.lex.c"
...
void mdsyyset_debug (int  bdebug )
{
        mdsyy_flex_debug = bdebug ;
}
