...
MODULE_INIT_FUNC(messaging)
{
	...
	PyModule_AddObject(m, "MSG_WINBIND_RELOAD_TRUSTED_DOMAINS", ndr_PyLong_FromUnsignedLongLong((uint32_t)MSG_WINBIND_RELOAD_TRUSTED_DOMAINS));
	PyModule_AddObject(m, "MSG_WINBIND_DISCONNECT_DC", ndr_PyLong_FromUnsignedLongLong((uint32_t)MSG_WINBIND_DISCONNECT_DC));
