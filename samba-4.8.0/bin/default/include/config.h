...
#define SRCDIR "/home/samba/samba-4.8.0"
#define HAVE_SYS_UTSNAME_H 1
#define SYSTEM_UNAME_SYSNAME "Linux"
#define SYSTEM_UNAME_MACHINE "x86_64"
#define SYSTEM_UNAME_RELEASE "4.4.218.x86_64.1"
#define SYSTEM_UNAME_VERSION "#1 SMP Mon Jan 11 06:25:23 UTC 2021"
...
#define EXPECTED_SYSTEM_LDB_VERSION_MINOR 3
#define EXPECTED_SYSTEM_LDB_VERSION_RELEASE 8
#define HAVE_LDWRAP 1
#define HAVE_KRB5 1
#define HAVE_KADM_SERVER 1
#define HAVE_LIBKADM5SRV_MIT 1
#define HAVE_KADM5_INIT 1
#define HAVE_KDB5 1
...
#define HAVE_KRB5_LOCALAUTH_PLUGIN_H 1
...
#define HAVE_GSS_ACQUIRE_CRED_FROM 1
...
#define HAVE_GNUTLS_CERTIFICATE_VERIFY_PEERS3 1
#define HAVE_GNUTLS_X509_H 1
#define HAVE_DECL_GNUTLS_CERT_EXPIRED 1
#define HAVE_DECL_GNUTLS_CERT_NOT_ACTIVATED 1
#define HAVE_DECL_GNUTLS_CERT_UNEXPECTED_OWNER 1
...
/* #undef HAVE_GPG_ERR_CODE_FROM_ERRNO */
/* #undef HAVE_GNUTLS_AEAD_CIPHER_INIT */
/* #undef HAVE_GPGME_NEW */
...
#define USING_SYSTEM_PARSE_YAPP_DRIVER 1
...
#define HAVE_TRACKER_SPARQL_1_0 1
#define WITH_SPOTLIGHT 1
#define HAVE_RPC_XDR_H 1
/* #undef HAVE_NSCD_FLUSH_CACHE */
#define STRING_STATIC_MODULES "vfs_default vfs_posixacl auth_builtin auth_sam auth_winbind rpc_mdssvc_module pdb_smbpasswd pdb_tdbsam auth_unix nss_info_template idmap_tdb idmap_passdb idmap_nss pdb_ldapsam idmap_ldap"
#define static_decl_vfs extern NTSTATUS vfs_default_init(TALLOC_CTX *mem_ctx); extern NTSTATUS vfs_posixacl_init(TALLOC_CTX *mem_ctx);
#define static_init_vfs(mem_ctx) { vfs_default_init((mem_ctx));  vfs_posixacl_init((mem_ctx)); }
...
#define static_decl_pdb extern NTSTATUS pdb_smbpasswd_init(TALLOC_CTX *mem_ctx); extern NTSTATUS pdb_tdbsam_init(TALLOC_CTX *mem_ctx); extern NTSTATUS pdb_ldapsam_init(TALLOC_CTX *mem_ctx);
#define static_init_pdb(mem_ctx) { pdb_smbpasswd_init((mem_ctx));  pdb_tdbsam_init((mem_ctx));  pdb_ldapsam_init((mem_ctx)); }
