...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->x509_ca_file_help = gengetopt_args_info_help[32] ;
  args_info->x509_cert_file_help = gengetopt_args_info_help[33] ;
  args_info->x509_key_file_help = gengetopt_args_info_help[34] ;
  args_info->priority_help = gengetopt_args_info_help[35] ;
  args_info->verbose_help = gengetopt_args_info_help[37] ;
  args_info->quiet_help = gengetopt_args_info_help[38] ;
