/* ***** BEGIN LICENSE BLOCK *****  
 * Source last modified: $Id: assembly.h,v 1.2 2006/03/29 17:22:08 hagi Exp $ 
 *   
...
/* toolchain:           gcc
 * target architecture: Infrant PADRE Processor
 */
#elif defined(__GNUC__) && defined(_PADRE)
...
static __inline Word64 MADD64(Word64 sum64, int x, int y)
{
	...
	__asm__ __volatile__ (
		...
		" addcc %%l1,%5,%1\n"
		" addx  %%l0,%4,%0\n"
		: "=r"(u.r.hi32), "=r"(u.r.lo32)
		: "r"(x), "r"(y), "r"(s.r.hi32), "r"(s.r.lo32)
		: "cc", "l0","l1"
		);
	return u.w64;
}
