/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: fileindextable.h,v 1.1.1.1 2006/03/29 16:45:27 hagi Exp $
 * 
...
public:
    ...
    virtual BOOL HasIndex(UINT32 ulTime);
...
public:
    ...
    virtual BOOL HasIndex(UINT16 uStreamNumber,
			  UINT32 ulTime);
