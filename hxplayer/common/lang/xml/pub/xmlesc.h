/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: xmlesc.h,v 1.1.1.1 2006/03/29 16:45:27 hagi Exp $
 * 
...
#include "growingq.h"
/****************************************************************************
 *  $Id: xmlesc.h,v 1.1.1.1 2006/03/29 16:45:27 hagi Exp $
 *
 *  NAME:	xmlesc.h
 *
 *  CLASS
...
public:
     ...
     *_______________________________________________________________________
     *~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
    CEscapeXMLtoHTML(IHXValues* pOptions, const char** pHotTags);
...
protected:
	...
	UINT32 tag_index;
	BOOL bInProcessingInstructions;
	BOOL bInInternalComment;
	BOOL bInDataSection;
	char cQuote;
    };
...
private:
     ...
     *_______________________________________________________________________
     *~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
    BOOL CheckTag(DataObject* pObj);
    
    BOOL PushOpenningHREF(const UCHAR* cp, CBigByteGrowingQueue* pQueue, char cEndQuote);
    ...
    UCHAR* GetParameter(const UCHAR* cp, UINT32 ulNameLen, BOOL bFullPath = FALSE);
