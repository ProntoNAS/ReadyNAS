/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: rpsmplxml.h,v 1.1.1.1 2006/03/29 16:45:27 hagi Exp $
 * 
 ...
 * 
 * ***** END LICENSE BLOCK ***** */
// $Id: rpsmplxml.h,v 1.1.1.1 2006/03/29 16:45:27 hagi Exp $
...
public:
    ...
    RPXMLParseResult NextTag( CRPSimpleXMLTag& tag, BOOL bStrict = TRUE );

private:

    BOOL _IsValidNameChar( char c );
...
inline BOOL CRPSimpleXMLParser::_IsValidNameChar( char c )
{
