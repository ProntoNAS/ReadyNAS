/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: hxxmlprs.h,v 1.1.1.1 2006/03/29 16:45:27 hagi Exp $
 * 
...
private:
    ...
    HX_RESULT DoParse			(BOOL bIsFinal);
...
public:
    HXLooseXMLParser			(BOOL bAllowNonXMLComments = FALSE);
...
public:
    HXXMLParser(BOOL bAllowNonXMLComments = FALSE);
