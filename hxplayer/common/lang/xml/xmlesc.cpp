/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: xmlesc.cpp,v 1.1.1.1 2006/03/29 16:45:27 hagi Exp $
 * 
...
//   $Id: xmlesc.cpp,v 1.1.1.1 2006/03/29 16:45:27 hagi Exp $
 ...
 *___________________________________________________________________________
 *~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
CEscapeXMLtoHTML::CEscapeXMLtoHTML(IHXValues* pOptions, const char** pHotTags) 
: m_pOurPath(NULL)
, m_pFileName(NULL)
, m_pRamGen(NULL)
, m_ulModDate(0)
...
, m_pServerUrl(NULL)
{
    ...
    BOOL bUseStyles = ulStyles ? TRUE : FALSE;
