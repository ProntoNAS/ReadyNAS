/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: bufdataf.h,v 1.1.1.1 2006/03/29 16:45:37 hagi Exp $
 * 
...
#ifndef _BUFFERED_DATA_FILE_H_
#define _BUFFERED_DATA_FILE_H_
...
class BufferedDataFile : public IHXDataFile
{
public:
					BufferedDataFile();
    virtual				~BufferedDataFile();
