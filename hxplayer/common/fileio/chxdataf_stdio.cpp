/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: chxdataf_stdio.cpp,v 1.1.1.1 2006/03/29 16:45:37 hagi Exp $
 * 
...
BOOL CHXDataFile::GetTemporaryFileName(const char *tag, char* name, UINT32 ulBufLen)
{
	return FALSE;
}
...
{
    CHXDataFile* pCHXDataFile = new CHXDataFile();
    return pCHXDataFile;
}
...
HX_RESULT
CHXDataFile::Create(const char *filename, UINT16 mode, BOOL textFlag)
{
    mode |= O_CREAT;
...
HX_RESULT
CHXDataFile::Open(const char *filename, UINT16 mode, BOOL textFlag)
{
