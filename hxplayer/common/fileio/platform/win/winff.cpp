/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: winff.cpp,v 1.1.1.1 2006/03/29 16:45:37 hagi Exp $
 * 
...
//
BOOL CWinFindFile::OS_OpenDirectory (const char *dirname)
{
#ifdef _WIN32
...
BOOL CWinFindFile::OS_InitPattern ()
{
    return TRUE;
}

BOOL CWinFindFile::OS_FileMatchesPattern (const char * fname)
{
