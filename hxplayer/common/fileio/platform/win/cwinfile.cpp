/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: cwinfile.cpp,v 1.1.1.1 2006/03/29 16:45:37 hagi Exp $
 * 
...
#include <windows.h>		// For GetTempPath(), etc.
...
HX_RESULT CWinFile::Create(const char *filename, UINT16 mode, BOOL textflag)
{
...
HX_RESULT CWinFile::Open(const char *filename, UINT16 mode, BOOL textflag)
{
...
HX_RESULT CWinFile::OpenShared(const char *filename, UINT16 mode, UINT16 sharedmode, BOOL textflag)
{
...
BOOL CWinFile::GetTemporaryFileName(const char *tag, char* name, UINT32 ulBufLen)
{
	BOOL bOk = FALSE;
