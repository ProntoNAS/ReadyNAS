/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: mmfile.cpp,v 1.1.1.1 2006/03/29 16:45:37 hagi Exp $
 * 
...
)
{
	...
	CHXFragmentedBuffer::CreateInstance(&punk);

	punk->QueryInterface(IID_IHXFragmentedBuffer, (void**)&pfbufOut);

	pfbufOut->Append(pbufOut, 0, ulCount);

	punk->QueryInterface(IID_IHXBuffer, (void**)ppbufOut);
