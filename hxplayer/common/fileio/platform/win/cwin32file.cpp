/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: cwin32file.cpp,v 1.1.1.1 2006/03/29 16:45:37 hagi Exp $
 * 
...
HX_RESULT CWin32File::Create(const char *filename, UINT16 mode, BOOL textflag)
{
...
HX_RESULT CWin32File::Open(const char *filename, UINT16 mode, BOOL textflag)
{
...
HX_RESULT CWin32File::OpenShared(const char *filename, UINT16 mode, UINT16 sharedmode, BOOL textflag)
{
...
BOOL CWin32File::GetTemporaryFileName(const char *tag, char* name, UINT32 ulBufLen)
{
    BOOL bOk = TRUE;
