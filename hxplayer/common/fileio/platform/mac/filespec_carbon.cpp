/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: filespec_carbon.cpp,v 1.1.1.1 2006/03/29 16:45:37 hagi Exp $
 * 
...
// ------------------------------------------------------------------------------------
CHXString CHXMacInternalSpec::GetURL(BOOL isDirectorySpec) const
{
	CHXString strURL;
	CHXCFURL cfurl;
...
{
	const BOOL kIsNotDirectory = FALSE;
