/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: cmacfile_carbon.cpp,v 1.1.1.1 2006/03/29 16:45:37 hagi Exp $
 * 
...
BOOL CMacFile::GetTemporaryFileName(const char *tag, char* name, UINT32 ulBufLen)
{
