/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: symbihxdataf.h,v 1.1.1.1 2006/03/29 16:45:37 hagi Exp $
 * 
...
#ifndef _SYMBIHXDATAF_H_
#define	_SYMBIHXDATAF_H_
...
#include "ihxsymbfsessionmgr.h"


/************************************************************************
 *  CIHX2CHXDataFile
 */
class CSymbIHXDataFile : public IHXAsyncDataFile
{
public:
	/*
	 *  Constructor
	 */
	CSymbIHXDataFile(IUnknown** ppCommonObj = NULL);
	 ...
	 */
	void Bind			(IHXBuffer* pFileNameBuffer);
	BOOL GetTemporaryFileName	(const char *tag, char* filename, UINT32 ulBufLen);
...
private:
	 ...
	 *  Destructor
	 */
	~CSymbIHXDataFile(void);

	/*
	 *  Private Methods
	 */
	HX_RESULT _Create(UINT16 uOpenMode, BOOL bCreateFile);

	inline TUint TranslateOpenMode(UINT16 uOpenMode);
	inline TSeek TranslateSeekMode(UINT16 fromWhere);
