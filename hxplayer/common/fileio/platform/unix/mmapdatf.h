/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: mmapdatf.h,v 1.1.1.1 2006/03/29 16:45:37 hagi Exp $
 * 
...
#ifndef UNIX_MMAPDATF_H
#define UNIX_MMAPDATF_H
...
class MemoryMapDataFile : public IHXDataFile
{
public:
					MemoryMapDataFile(IUnknown* pContext,
					    REF(IUnknown*) pPersistantObject,
					    BOOL bDisableMemoryMappedIO = FALSE,
					    UINT32 ulChunkSize = 0,
					    BOOL bEnableFileLocking = FALSE);
    virtual				~MemoryMapDataFile();
