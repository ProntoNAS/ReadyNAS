/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: copwavef.cpp,v 1.1.1.1 2006/03/29 16:45:37 hagi Exp $
 * 
...
HX_RESULT COpenwaveFile::Create(const char *filename, UINT16 mode, BOOL textflag)
{
...
HX_RESULT COpenwaveFile::Open(const char *filename, UINT16 mode, BOOL textflag)
{
    // close previous file if necessary
    if ( mFD > 0 )
    {
...
BOOL COpenwaveFile::GetTemporaryFileName(const char *tag, char* name, UINT32 ulBufLen)
{
    // TBF
