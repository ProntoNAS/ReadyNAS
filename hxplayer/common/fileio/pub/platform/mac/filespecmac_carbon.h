/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: filespecmac_carbon.h,v 1.1.1.1 2006/03/29 16:45:38 hagi Exp $
 * 
...
public:
	...
	BOOL operator==(const CHXMacInternalSpec &other);
	BOOL operator!=(const CHXMacInternalSpec &other);
	...
	CHXString GetURL(BOOL isDirectorySpec) const;
