/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: cwinfile.h,v 1.1.1.1 2006/03/29 16:45:38 hagi Exp $
 * 
...
/* 	Open will open a file for sharing with the specified permissions 
	returns HXR_OK or -1 if an error occurred */
	virtual HX_RESULT		OpenShared(const char *filename, UINT16 mode, UINT16 sharedmode, BOOL textflag = 0);
