/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: filespecopwave.h,v 1.1.1.1 2006/03/29 16:45:38 hagi Exp $
 * 
...
The path parser code is almost a complete clone of the version found in
the Windows filespec code. The volume name thing doesn't make sense in
unixland, and a few other bits were changed, but the idea is the same.

*/

#ifndef FILESPECOPWAVE_H
#define FILESPECOPWAVE_H
