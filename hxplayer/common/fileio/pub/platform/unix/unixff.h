/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: unixff.h,v 1.1.1.1 2006/03/29 16:45:38 hagi Exp $
 * 
...
#ifndef __UNIXFINDFILE_H
#define __UNIXFINDFILE_H
...
class CUnixFindFile : public CFindFile
{
public:

	CUnixFindFile	(const char *path,
