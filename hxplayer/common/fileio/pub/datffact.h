/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: datffact.h,v 1.1.1.1 2006/03/29 16:45:37 hagi Exp $
 * 
...
#ifndef _DATA_FILE_FACT_H_
#define _DATA_FILE_FACT_H_

/*
 * 
 *  Interface:
 *
 *	IHXDataFileFactory & IHXDataFile
 *
 *  Purpose:
 *
...
class HXDataFileFactory : public IHXDataFileFactory
{
public:
    					HXDataFileFactory();
    virtual 				~HXDataFileFactory();
    /*
     *  IUnknown methods
     */
    ...
    STDMETHOD(CreateFile)		(THIS_
					...
					BOOL bDisableMemoryMappedIO,
					UINT32 ulChunkSize,
					BOOL bEnableFileLocking,
					BOOL bPreferAsyncIO);
...
inline
HXDataFileFactory::HXDataFileFactory()
		 : m_lRefCount(0)
{
}
