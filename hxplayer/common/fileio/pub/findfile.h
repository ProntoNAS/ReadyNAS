/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: findfile.h,v 1.1.1.1 2006/03/29 16:45:38 hagi Exp $
 * 
...
protected:
	...
	virtual BOOL	OS_OpenDirectory (const char * dirName) = 0;
	...
	virtual BOOL	OS_InitPattern () = 0;
	virtual BOOL	OS_FileMatchesPattern (const char * fname) = 0;
