/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: chxdfmem.h,v 1.1.1.1 2006/03/29 16:45:37 hagi Exp $
 * 
...
/* 	Create creates a file using the specified mode */
	virtual HX_RESULT	Create				(const char *filename, UINT16 mode, BOOL textflag = 1)
												{ return HXR_FAILED; }

	/* 	Open will open a file with the specified permissions */
	virtual HX_RESULT	Open				(const char *filename, UINT16 mode, BOOL textflag = 1)
												{ return HXR_FAILED; }
