/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: hxbasedir.h,v 1.1.1.1 2006/03/29 16:45:38 hagi Exp $
 * 
...
{
public:
    static XHXDirectory* Construct(IUnknown** ppCommonObj = NULL);
    ...
    virtual BOOL SetTempPath(HXXHANDLE hpsHandle, const char* szRelPath) = 0;
    ...
    /* Destroys directory. */
    virtual BOOL Destroy(BOOL bRemoveContents);

    /* Deletes file. */
    virtual BOOL DeleteFile(const char* szRelPath) = 0;

    /* Sets itself to current directory. */
    virtual BOOL SetCurrentDir() = 0;

    /* Makes itself a current directory. */
    virtual BOOL MakeCurrentDir() = 0;
