/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: cchx2ihxdataf.h,v 1.1.1.1 2006/03/29 16:45:37 hagi Exp $
 * 
...
typedef	BOOL (*TemporaryFileNameFnPtr) (void* pUserData, const char *tag, char* filename, UINT32 ulBufLen);
...
public:
	 ...
	 */
	CCHX2IHXDataFile(IHXDataFile* pIHXFile,
			 void* pUserData,
...
private:
	 ...
	 *  Private methods
	 */
	inline UINT16 TranslateMode(UINT16 uOpenMode, BOOL bTextflag);
