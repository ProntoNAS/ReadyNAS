/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: hxbufdataf.h,v 1.1.1.1 2006/03/29 16:45:37 hagi Exp $
 * 
...
#ifndef _HX_BUFFERED_DATA_FILE_H_
#define _HX_BUFFERED_DATA_FILE_H_

#include "hxtypes.h"
#include "hxcom.h"
#include "hxdataf.h"

class HXBufferedDataFile : public IHXDataFile {
public:
					HXBufferedDataFile();
    virtual				~HXBufferedDataFile();
...
private:
    ...
    HXBufferedDataFile(const HXBufferedDataFile&);
    HXBufferedDataFile& operator=(const HXBufferedDataFile&);
...
#endif /* _HX_BUFFERED_DATA_FILE_H_ */
