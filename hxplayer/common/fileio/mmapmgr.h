/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: mmapmgr.h,v 1.1.1.1 2006/03/29 16:45:37 hagi Exp $
 * 
...
{
public:
    MemoryMapManager(IUnknown* pContext, BOOL bDisableMemoryMappedIO = 0,
...
#define FILEINFO_KEY_SIZE   32
    ...
    static BOOL CheckAndReapPageTableEntry(struct _PageTableEntry* pPTE);
private:
