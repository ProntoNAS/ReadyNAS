/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: hxxfile.cpp,v 1.1.1.1 2006/03/29 16:45:37 hagi Exp $
 * 
...
void HXXFile::GetReasonableLocalFileName(CHXString& fileName)
{
	...
	//////////////////////////////////////////////////////
	// Replace all drive markers with correct platform
	// specific drive markers!
	//
#if defined (_WINDOWS)
	nFoundAt = 0;
	do
...
BOOL HXXFile::IsPlusURL(const char* pURL)
{
