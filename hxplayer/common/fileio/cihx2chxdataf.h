/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: cihx2chxdataf.h,v 1.1.1.1 2006/03/29 16:45:37 hagi Exp $
 * 
 ...
 *  CIHX2CHXDataFile
 */
class CIHX2CHXDataFile : public IHXDataFile
{
public:
	/*
	 *  Constructor
	 */
	CIHX2CHXDataFile(UINT32 ulFlags = 0, IUnknown** ppCommonObj = NULL);
	...
	/*
	 *  CIHX2CHXDataFile methods
	 */
	CHXDataFile* GetCHXDataFile(void)	{ return m_pCHXFile; }
...
private:
	 ...
	 *  Destructor
	 */
	virtual ~CIHX2CHXDataFile(void);

	/*
	 *  Private methods
	 */
	inline UINT16 TranslateMode(UINT16 uOpenMode);

	CHXDataFile* m_pCHXFile;
