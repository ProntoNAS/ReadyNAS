/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: genthrd.cpp,v 1.1.1.1 2006/03/29 16:45:35 hagi Exp $
 * 
...
HX_RESULT	
HXGenThread::GetMessage(HXThreadMessage* pMsg, UINT32 ulMsgFilterMix, UINT32 ulMsgFilterMax)
{
    return HXR_OK;
}
...
HXGenEvent::HXGenEvent(const char* pEventName, BOOL bManualReset)
{
}
