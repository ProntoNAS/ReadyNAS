/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: hxloader.h,v 1.1.1.1 2006/03/29 16:45:36 hagi Exp $
 * 
 ...
 *	the loaded module.
 */
BOOL __export FAR PASCAL RAFreeLibrary( ULONG32 dwhLib );
 ...
 */
BOOL __export FAR PASCAL RAVerQueryValue( LPCSTR lpvBlock, LPCSTR lpszSubBlock, void FAR* FAR* lplpBuffer, ULONG32 *lpdwCount );
