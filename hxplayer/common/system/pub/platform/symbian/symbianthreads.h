/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: symbianthreads.h,v 1.1.1.1 2006/03/29 16:45:36 hagi Exp $
 * 
...
public:
    ...
    HXSymbianEvent(const char* pEventName = NULL, BOOL bManualReset=TRUE);
