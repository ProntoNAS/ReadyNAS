/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: staticff.h,v 1.1.1.1 2006/03/29 16:45:36 hagi Exp $
 * 
...
#ifndef __STATICFINDFILE_H
#define __STATICFINDFILE_H
...
class CStaticFindFile : public CFindFile
{
public:
  static CStaticFindFile*   CreateFindFile( const char *path,
				      const char *delimiter,
				      const char *pattern) { return new CStaticFindFile(path, delimiter, pattern) ;};

	CStaticFindFile	(const char *path,
			const char *delimiter,
			const char *pattern);
...
protected:
	...
	// variables here!
        const DLLTYPEMAP *m_dirHandle;
};

#endif // __UNIXFINDFILE_H
