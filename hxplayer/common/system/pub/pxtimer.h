/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: pxtimer.h,v 1.1.1.1 2006/03/29 16:45:36 hagi Exp $
 * 
...
protected:
    ...
    BOOL             m_bInsideTimerFire;

    void Deallocate();
    BOOL IsCallbackPending();
    void RemovePendingCallback();
};

inline BOOL PXTimer::IsCallbackPending()
{
