/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: hxstatic_gm_inst.h,v 1.1.1.1 2006/03/29 16:45:35 hagi Exp $
 * 
...
#ifndef STATIC_GM_INST_H
#define STATIC_GM_INST_H
...
private:
    static HXGlobalManager* zm_pInstance;
};
...
{
    zm_pInstance = pInstance;
}


#endif /* STATIC_GM_INST_H */
