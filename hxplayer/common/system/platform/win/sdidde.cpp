/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: sdidde.cpp,v 1.1.1.1 2006/03/29 16:45:36 hagi Exp $
 * 
...
BOOL BrowserOpenURL(const char* pszUrl, const char* pszTarget, const char* pszDefBrowser) 
{
