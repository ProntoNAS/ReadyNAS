/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: ihxtlogsystemcontext.h,v 1.1.1.1 2006/03/29 16:45:28 hagi Exp $
 * 
...
DECLARE_INTERFACE_(IHXTLogSystemContext, IUnknown)
{
	...
	STDMETHOD(SetThreadJobName) (THIS_ const char* szJobName, UINT32 nThreadId, BOOL bPropogateChange = FALSE) PURE;
