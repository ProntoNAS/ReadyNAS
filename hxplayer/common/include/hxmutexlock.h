/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: hxmutexlock.h,v 1.1.1.1 2006/03/29 16:45:28 hagi Exp $
 * 
 ...
 *
 * inline void HXMutexLock(HX_MUTEX pLock, BOOL bWait = FALSE)
 ...
 *
 * inline BOOL HXMutexTryLock(HX_MUTEX pLock)
