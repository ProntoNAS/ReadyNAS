/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: hxsdesc.h,v 1.1.1.1 2006/03/29 16:45:28 hagi Exp $
 * 
...
DECLARE_INTERFACE_(IHXRTPPayloadInfo, IUnknown)
{
     ...
     */
    STDMETHOD_(BOOL, IsPayloadSupported)	    (THIS_
     ...
     */
    STDMETHOD_(BOOL, IsTimestampDeliverable)	    (THIS_
				UINT32      /*IN*/  ulRTPPayloadType) PURE;
};
