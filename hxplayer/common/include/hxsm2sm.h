/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: hxsm2sm.h,v 1.1.1.1 2006/03/29 16:45:28 hagi Exp $
 * 
...
DEFINE_GUID(IID_IHXSmilToSmilRendererCommunicator,
	    0x00004300, 0x901, 0x11d1, 0x8b, 0x6, 0x0, 0xa0, 0x24, 0x40, 0x6d, 0x59);

#undef INTERFACE
#define INTERFACE IHXSmilToSmilRendererCommunicator

DECLARE_INTERFACE_(IHXSmilToSmilRendererCommunicator, IUnknown)
{
    /***********************************************************************/
    /*
     *	IUnknown methods
