/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: windows.cpp,v 1.1.1.1 2006/03/29 16:45:33 hagi Exp $
 * 
...
BOOL __helix_GetDiskFreeSpace(LPCTSTR lpRootPathName,
			      ...
			      LPDWORD lpTotalNumberOfClusters)
{
    ...
    BOOL ret = GetDiskFreeSpaceEx(lpRootPathName,
