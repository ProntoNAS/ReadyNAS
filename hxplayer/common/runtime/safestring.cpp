/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: safestring.cpp,v 1.1.1.1 2006/03/29 16:45:33 hagi Exp $
 * 
...
char* SafeStrCat(char* pDestStr, const char* pSourceStr, UINT32 ulBufferSize)
{
    ...
    if (pDestStr && pSourceStr && ulBufferSize)
    {
        ...
        UINT32 ulDestStrLength = pDestStrEnd - pDestStr;

        // If the length of the destination string is longer than the buffer size then we cannot concatenate anything
