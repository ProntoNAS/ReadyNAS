/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: map_prof_base.h,v 1.1.1.1 2006/03/29 16:45:28 hagi Exp $
 * 
...
#ifndef MAP_PROF_BASE_H
#define MAP_PROF_BASE_H

class GenMapProfBase
{
public:
    virtual ~GenMapProfBase();

    // Store manipulation
    virtual bool CreateElement(int index) = 0;
    virtual bool CreateElements(int index, int num) = 0;
    ...
    virtual bool RunMapSpecificProfs() = 0;

    virtual bool ProfileInsertions(const char* typeName) = 0;
    virtual bool InitHashTable(int numBuckets) = 0;
};

#endif // MAP_PROF_BASE_H
