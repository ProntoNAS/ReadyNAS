/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: hxguid.h,v 1.1.1.1 2006/03/29 16:45:28 hagi Exp $
 * 
...
public:
    ...
    BOOL Set(REFGUID guid);
    BOOL Set(const char* pString);

    BOOL Get(CHXString& string);
    BOOL Get(char* pBuffer, INT32 bufLen);
...
inline BOOL CHXIID::Set(REFIID iid)
{
...
inline BOOL CHXCLSID::Set(REFIID iid)
{
    return(CHXGUID::Set(iid));
}
