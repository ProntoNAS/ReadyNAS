/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: hxset.h,v 1.1.1.1 2006/03/29 16:45:28 hagi Exp $
 * 
...
// Attributes
	...
	BOOL Remove(void* pMember);
	void RemoveAll();

	BOOL Lookup(void *pMember);
...
inline BOOL CHXSet::IsEmpty(void) const
{
...
inline BOOL CHXSet::Remove(void *pMember)
{
...
inline BOOL CHXSet::Iterator::operator==(const CHXSet::Iterator& iter) const
{
