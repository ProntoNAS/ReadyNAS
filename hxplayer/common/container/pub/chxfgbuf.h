/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: chxfgbuf.h,v 1.1.1.1 2006/03/29 16:45:28 hagi Exp $
 * 
...
public:
    ...
    {}
    ~_CBufferFragment()
    {HX_RELEASE(m_pData); m_ulStart=0; m_ulLength=0;}
...
private:
	...
	_CFragment():m_pData(NULL),m_pPrev(NULL),m_pNext(NULL){}
	~_CFragment()
	{
	    HX_RELEASE(m_pData); 
	    if(m_pNext)
