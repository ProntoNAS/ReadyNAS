/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: hxasvect.h,v 1.1.1.1 2006/03/29 16:45:28 hagi Exp $
 * 
...
public:
    ...
    protected:
        ...
        Iterator(Data::iterator it DEBUG_CODE(DEBUG_COMMA CHXGenericAssocVect* pCont))
            : value_(it)
        {
            DEBUG_CODE(pCont_ = pCont; serial_ = pCont->m_Serial;)
        }
