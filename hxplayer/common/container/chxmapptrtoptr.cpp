/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: chxmapptrtoptr.cpp,v 1.1.1.1 2006/03/29 16:45:28 hagi Exp $
 * 
...
#define MAP_TYPE CHXMapPtrToPtr
#include "chxmapcommon_inl.h"

DECLARE_ITEMVEC_IMP(CHXMapPtrToPtr,ItemVec_t,Item,Item(),0,0);
...
ULONG32 CHXMapPtrToPtr::DefaultHashFunc (key_type key)
{
    // XXXSAB: Need something to reasonably distribute ptrs...anyone have
    //         an idea?
    ULONG32 ret = (ULONG32)(PTR_INT)key;
    ret = ret ^ ((ret << 8) | (ret >> (sizeof(ULONG32)*8 - 8)));
    return ret;
}

void CHXMapPtrToPtr::Dump() const
{
#ifdef _DEBUG
    int i;
    printf("(CHXMapPtrToPtr*)%p:\n", this);
