/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: hxguid.cpp,v 1.1.1.1 2006/03/29 16:45:28 hagi Exp $
 * 
...
#if defined _MACINTOSH || defined _UNIX || defined _SYMBIAN
...
BOOL CHXGUID::Set(REFGUID guid)
{
    ::SetGUID(m_guid, guid);
    return(TRUE);
}

BOOL CHXGUID::Set(const char* pString)
{
#if defined(HELIX_FEATURE_FULLGUID)
    CHXString t1, t2;
    t1 = pString;
...
BOOL CHXGUID::Get(CHXString& string)
{
...
BOOL CHXGUID::Get(char* pBuffer, INT32 bufLen)
{
#if !defined(HELIX_FEATURE_FULLGUID)
    BOOL bRet = FALSE;
