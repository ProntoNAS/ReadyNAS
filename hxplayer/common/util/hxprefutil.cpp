/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: hxprefutil.cpp,v 1.1.1.1 2006/03/29 16:45:31 hagi Exp $
 * 
...
HX_RESULT
ReadPrefINT32(IHXPreferences* pPreferences, const char* pszName, UINT32& ulValue)
{
    HX_RESULT   rc = HXR_OK;
...
HX_RESULT
ReadPrefINT16(IHXPreferences* pPreferences, const char* pszName, UINT16& ulValue)
{
    HX_RESULT   rc = HXR_OK;
    IHXBuffer*  pBuffer = NULL;
...
ReadPrefFLOAT(IHXPreferences* pPreferences, const char* pszName, HXFLOAT& fValue)
{
    ...
    if (pPreferences && HXR_OK == pPreferences->ReadPref(pszName, pBuffer))
    {
        fValue = atof((const char*) pBuffer->GetBuffer());
        HX_RELEASE(pBuffer);
    }
    else
    {
...
HX_RESULT   
ReadPrefBOOL(IHXPreferences* pPreferences, const char* pszName, BOOL& ulValue)
{
    HX_RESULT   rc = HXR_OK;
    IHXBuffer*  pBuffer = NULL;
