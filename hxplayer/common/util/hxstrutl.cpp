/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: hxstrutl.cpp,v 1.1.1.1 2006/03/29 16:45:31 hagi Exp $
 * 
...
int CopyP2CString(ConstStr255Param inSource, char* outDest, int inDestLength)
{
	...
	{
		outLength = *inSource++;
		outLength = min( outLength, ( inDestLength - 1 ) );
...
void
StrAllocCopy(char*& pDest, char* pSrc)
{
...
HX_RESULT
SaveStringToHeader(IHXValues* pHeader, const char* pszKey, char* pszValue)
{
    HX_RESULT	hr = HXR_OK;
