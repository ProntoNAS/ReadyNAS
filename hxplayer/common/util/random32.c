/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: random32.c,v 1.1.1.1 2006/03/29 16:45:31 hagi Exp $
 * 
...
* Functions used to create "s" is reduced, but that should be fine...
*/
UINT32 random32(int type)
{
   struct {
    ...
    s.type  = type;
    s.tick  = HX_GET_TICKCOUNT();
    s.rand  = rand();
    
    return md_32((const unsigned char *)&s, sizeof(s));   
}
