/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: nptime.cpp,v 1.1.1.1 2006/03/29 16:45:31 hagi Exp $
 * 
...
NPTime::NPTime(const char* pTimeString, BOOL bAllow_h_min_s_ms_units,
	       BOOL& bSucceeded)
{
    bSucceeded = TRUE;
