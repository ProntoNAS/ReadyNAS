/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: MoreFilesX.c,v 1.1.1.1 2006/03/29 16:45:31 hagi Exp $
 * 
	...
	Boolean *isDirectory)	/* can be NULL */
{
	...
	require_noerr_quiet(result, FSGetCatalogInfo);
...
#if 0	// GR 3/18/02 not in whatever libraries we're currently linking against
