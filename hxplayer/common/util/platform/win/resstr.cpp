/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: resstr.cpp,v 1.1.1.1 2006/03/29 16:45:32 hagi Exp $
 * 
...
BOOL ResStr::LoadStr( UINT32 iResNum )
{
	UINT32		iLen;
	BOOL	btRes;
	char	*pcBuff;
...
//	strings.
BOOL ResStr::LoadRes( UINT32 iRes, char *pcBuffer, UINT32 iMax )
{
	int	iLoad;
