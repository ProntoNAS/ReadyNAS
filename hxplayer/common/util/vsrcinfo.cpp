/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: vsrcinfo.cpp,v 1.1.1.1 2006/03/29 16:45:31 hagi Exp $
 * 
...
QueueModificationTime(CBigByteGrowingQueue* pQ, UINT32 ulModTime)
{
    if ( ulModTime )
    {
	pQ->EnQueue(z_pLastModified);
	UTCTimeRep t(ulModTime);
	pQ->EnQueue(t.asRFC1123String());
