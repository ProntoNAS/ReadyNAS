/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: hxstrutl.h,v 1.1.1.1 2006/03/29 16:45:32 hagi Exp $
 * 
...
#define IS_SPACE(x)	((((unsigned int) (x)) > 0x7f) ? 0 : isspace(x))

#ifdef __cplusplus
void	    StrAllocCopy(char*& pDest, char* pSrc);
#else
void	    StrAllocCopy(char** pDest, char* pSrc);
#endif
