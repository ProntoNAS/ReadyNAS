/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: chxminiccf.h,v 1.1.1.1 2006/03/29 16:45:32 hagi Exp $
 * 
...
#ifndef _CHXMINICCF_H_
#define _CHXMINICCF_H_

#include "hxcom.h"
#include "hxccf.h"

class CHXMiniCCF : public IHXCommonClassFactory
{
public:
    CHXMiniCCF();
    ~CHXMiniCCF();
