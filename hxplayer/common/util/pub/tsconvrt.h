/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: tsconvrt.h,v 1.1.1.1 2006/03/29 16:45:32 hagi Exp $
 * 
...
public:
    ...
    void SetOffset(ULONG32 ulOffset, BOOL bUseOutScale = TRUE)
    {
	if (bUseOutScale)
	{
    ...
    ULONG32 GetOffset(BOOL bUseOutScale = TRUE)
    {
	if (bUseOutScale)
	{
