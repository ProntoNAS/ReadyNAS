/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: hxprefutil.h,v 1.1.1.1 2006/03/29 16:45:32 hagi Exp $
 * 
...
HX_RESULT ReadPrefINT32(IHXPreferences* pPreferences, const char* pszName,
                        UINT32& ulValue);

HX_RESULT ReadPrefINT16(IHXPreferences* pPreferences, const char* pszName,
                       UINT16& ulValue);
