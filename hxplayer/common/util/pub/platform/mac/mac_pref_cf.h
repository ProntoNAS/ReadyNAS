/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: mac_pref_cf.h,v 1.1.1.1 2006/03/29 16:45:32 hagi Exp $
 * 
...
public:
	...
	static	CMacPref	*open_pref (const char* pCompanyName, const char* pProductName, int nProdMajorVer, int nProdMinorVer, BOOL bCommon = TRUE);
...
private:	
	...
	CMacPref(const char* pCompanyName, const char* pProductName, int nProdMajorVer, int nProdMinorVer, BOOL bCommon);		// ctor
	...
	*/
	...
	CHXPtrArray	m_arrSubKeyStack; // when we're in nested BeginSubPrefs, stores previous CHXStrings with the prefixes
   	...
   	HX_RESULT GetPrefKeyInternal(UINT32 nIndex,BOOL bReturnDeeperNestings,CHXString& outStrKey);
