/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: unix_pref.h,v 1.1.1.1 2006/03/29 16:45:32 hagi Exp $
 * 
...
protected:
    ...
    BOOL            EscapeNewLine(const char* pLine, char*& pOutLine);
    BOOL            UnescapeNewLine(const char* pLine, char*& pOutLine);
    ...
    void            ConstructPrefAssignment(const char *pref, const char *pValue,
					    CHXString &ret, BOOL bEscapeValue);
