/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: symbian_pref.h,v 1.1.1.1 2006/03/29 16:45:32 hagi Exp $
 * 
...
#ifndef _SYMBIAN_PREF
#define _SYMBIAN_PREF
...
class CSymbianPref : public CPref 
{
  public:
    ...
    static  CSymbianPref* open_pref (const char* pCompanyName,
  ...
  protected:
    ...
    CSymbianPref( const char* pCompanyName,
                  const char* pProductName,
                  int nProdMajorVer,
                  int nProdMinorVer);
