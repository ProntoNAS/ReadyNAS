/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: win_pref.h,v 1.1.1.1 2006/03/29 16:45:32 hagi Exp $
 * 
...
/* 	call open_pref() to automatically create the correct Windows specific preference object. */
	static	CWinPref	*open_pref  	(const char* pCompanyName, const char* pProductName, int nProdMajorVer, int nProdMinorVer, BOOL bCommon = TRUE);
