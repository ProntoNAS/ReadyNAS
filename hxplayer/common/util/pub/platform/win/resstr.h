/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: resstr.h,v 1.1.1.1 2006/03/29 16:45:32 hagi Exp $
 * 
...
private:
	...
	static BOOL	LoadRes( UINT32 iRes, char *pcBuffer, UINT32 iMax );
};
