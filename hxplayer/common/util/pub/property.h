/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: property.h,v 1.1.1.1 2006/03/29 16:45:32 hagi Exp $
 * 
...
Property::Property()
	   ...
	   _owner_node(0), _id(0), _alternate_string_access_ok(0), m_LastError(HXR_OK)
{
...
Property::Property(Key* k, HXPropType t) 
	   ...
	   _deleted(FALSE), _read_only(FALSE), _owner_db(0), 
	   _owner_node(0), _id(0), m_LastError(HXR_OK)
{
...
inline void
Property::set_read_only(BOOL read_only)
{
