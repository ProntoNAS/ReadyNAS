/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: portaddr.h,v 1.1.1.1 2006/03/29 16:45:32 hagi Exp $
 * 
...
BOOL	    IsValidWildcardEntry(const char* pszValue);
BOOL	    IsValidSubnetEntry(const char* pszValue);
...
public:
    ...
    virtual BOOL IsEqual(const char* pszValue) = 0;
};
...
public:
    ...
    BOOL IsEqual(const char* pszValue);
};
...
public:
    ...
    BOOL    IsSubnet(const char* pszDomain);
    void    Close(void);
};
...
public:
     ...
     */
    STDMETHOD_(BOOL, IsExemptionHost)	(THIS_
					 char* pszDomain);
