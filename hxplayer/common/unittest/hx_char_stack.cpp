/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: hx_char_stack.cpp,v 1.1.1.1 2006/03/29 16:45:27 hagi Exp $
 * 
...
const char* HLXCharStack::StrSep(const char* str, const char* sep)
{
