 ...
 */
  ...
  enum { DOCUMENT_POSITION_DISCONNECTED = 32U };

  enum { DOCUMENT_POSITION_PRECEDING = 1U };

  enum { DOCUMENT_POSITION_FOLLOWING = 2U };

  enum { DOCUMENT_POSITION_CONTAINS = 4U };

  enum { DOCUMENT_POSITION_IS_CONTAINED = 8U };

  enum { DOCUMENT_POSITION_IMPLEMENTATION_SPECIFIC = 16U };
