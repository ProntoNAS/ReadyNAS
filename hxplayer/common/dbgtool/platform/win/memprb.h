/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: memprb.h,v 1.1.1.1 2006/03/29 16:45:37 hagi Exp $
 * 
...
#define PNMEMPROBE_PRIVATE_DATA	_CrtMemState		m_MemRefPoint;\
				...
				static BOOL		m_bMutexInitialized;\
				static CRITICAL_SECTION	m_Mutex;

#if (defined(_MSC_VER) && (_MSC_VER > 1100) && defined(_BASETSD_H_)) /* VC 6 Check */
#define PNMEMPROBE_PRIVATE_METHODS  HX_RESULT MakeBlockInfo(MemBlockInfo &Info, BOOL bWithCrt);\
                    ...
                    void _DumpMemUsedSinceReset(FILE *pFile, BOOL bWithCrt);\
