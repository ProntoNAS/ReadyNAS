/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: hxassert.cpp,v 1.1.1.1 2006/03/29 16:45:36 hagi Exp $
 * 
...
#endif
{
	...
	TCHAR	szBuffer[10] = TEXT(""); /* Flawfinder: ignore */
	HKEY 	hKey;
	BOOL 	bEnabled = FALSE;
	HX_RESULT hRes;
	...
	{
		hRes = RegQueryValue(hKey, "", (char*)szBuffer, (long *)&bufSize);
