/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: conn.h,v 1.1.1.1 2006/03/29 16:45:28 hagi Exp $
 * 
...
{
public:
    virtual HX_RESULT Func(NotificationType Type, BOOL bSuccess = TRUE, conn* pConn = NULL) = 0;
};
...
//	virtual HX_RESULT	accept			(ULONG32* pAddr) = 0;
	...
	virtual HX_RESULT	SetupEndpoint(BOOL bWait) {return HXR_NOTIMPL;}
#endif
