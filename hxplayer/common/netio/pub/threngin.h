/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: threngin.h,v 1.1.1.1 2006/03/29 16:45:28 hagi Exp $
 * 
...
{
public:
    static ThreadEngine*    GetThreadEngine(void);
    static void		    DestroyThreadEngine(void);

    HXThread*	    GetNetworkThread(void) {return m_pNetworkThread;};
    HXThread*	    GetMainAppThread(void) {return m_pMainAppThread;};
    HXMutex*	    GetMutex(void) {return m_pMutex;};
