/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: unix_net.h,v 1.1.1.1 2006/03/29 16:45:28 hagi Exp $
 * 
...
public:  
  ...
  static unix_net *new_socket (UINT16 type);
...
protected:
  ...
  BOOL               m_DNSOnly; //Used for DNS only objects.
