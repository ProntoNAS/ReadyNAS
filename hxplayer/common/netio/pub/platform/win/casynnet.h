/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: casynnet.h,v 1.1.1.1 2006/03/29 16:45:28 hagi Exp $
 * 
...
public:
    ...
    BOOL		DoAsyncDNS(win_net* fpSock, LPCSTR lpHostName, 
				   LPSTR pBuff, int cbBuffLen);
    BOOL		DoAsyncSelect(win_net* fpSock);
    BOOL		CancelSelect(win_net* fpSock);
...
protected:
    ...
    static LRESULT HXEXPORT AsyncNotifyProc(HWND hWnd, UINT msg, 
    ...
    static BOOL		zm_bClassRegistered;
    ...
    BOOL		m_bInCancelMode;

    BOOL		ProcessDNSQueue();
};

class SockGlobals
{
public:
    BOOL		m_bWinSock2Suck;
