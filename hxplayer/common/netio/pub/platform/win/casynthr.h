/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: casynthr.h,v 1.1.1.1 2006/03/29 16:45:28 hagi Exp $
 * 
...
{
public:
    static CAsyncNetThread* GetCAsyncNetThreadNotifier(HINSTANCE hInst, 
					      BOOL Create = FALSE);
...
protected:
    ...
    CAsyncNetThread(HINSTANCE hInst);
