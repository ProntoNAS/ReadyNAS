/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: win_net.h,v 1.1.1.1 2006/03/29 16:45:28 hagi Exp $
 * 
...
/*  call new_socket() to automatically create the correct platform specific network object.
    ...
    static	win_net	*new_socket 	(UINT16 type);
...
/*  call done() when you are finsihed with the socket. Done() will close the socket.
    ...
    virtual void IgnoreWSAECONNRESET(BOOL b) {m_bIgnoreWSAECONNRESET = b;}
...
public :
    ...
    HX_RESULT	set_broadcast(BOOL enable);
