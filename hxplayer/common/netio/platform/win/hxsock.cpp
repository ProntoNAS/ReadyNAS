/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: hxsock.cpp,v 1.1.1.1 2006/03/29 16:45:28 hagi Exp $
 * 
...
void CHXSock::UnloadWinsock(BOOL bDestuction)
{
	if (m_hLib)
	{
		FreeLibrary( m_hLib );
