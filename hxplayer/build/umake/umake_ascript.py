# 
# ***** BEGIN LICENSE BLOCK *****
# Source last modified: $Id: umake_ascript.py,v 1.1.1.1 2006/03/29 16:45:39 hagi Exp $
# 
...
def ProjectToMacCWProjectData(platform, project):
    ...
    mprj.target_type = project.target_type
...
class ASMakefile:
    ...
    def __init__(self, mprj):
        ...
        ## for DRM signing
        if mprj.project.target_type == "dll" and \
    ...
    def Clean(self):
        ...
        if self.mprj.project.target_type != "":
            self.script.Append(
                '  tell application "Finder"',
                '    with timeout of 99999 seconds',
...
def make_makefile(platform, project):
    ## FIX pncrt madness
    if project.target_type == "exe" or \
           project.target_type == "dll" :
        fix_pncrt(project)
