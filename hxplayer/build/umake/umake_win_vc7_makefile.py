# ***** BEGIN LICENSE BLOCK *****
# Source last modified: $Id: umake_win_vc7_makefile.py,v 1.1.1.1 2006/03/29 16:45:39 hagi Exp $
# 
...
class Config(Config):
    ...
    def parse_options(self, name, flags, func, argstring, defopts=None,
        ...
        # getting set.
        log.debug('Calling makefile.expand_variables($(%s) , %s )' % \
                              ( flags, self.variables ))                               
        line = makefile.expand_variables("$(%s)"%flags,  self.variables)        
        log.debug('makefile.expand_variables returned: %s' % line )
