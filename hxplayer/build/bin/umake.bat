...
REM Source last modified: $Id: umake.bat,v 1.1.1.1 2006/03/29 16:45:39 hagi Exp $
REM 
...
REM 
REM $Id: umake.bat,v 1.1.1.1 2006/03/29 16:45:39 hagi Exp $
REM bootstrap UMAKE on Windows

python %BUILD_ROOT%\bin\umake %1 %2 %3 %4 %5 %6 %7 %8 %9
