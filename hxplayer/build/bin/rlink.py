...
# 
# ***** BEGIN LICENSE BLOCK *****
# Source last modified: $Id: rlink.py,v 1.1.1.1 2006/03/29 16:45:39 hagi Exp $
# 
...
def run2(args):
    run(string.join(map(quote,args)), True)
