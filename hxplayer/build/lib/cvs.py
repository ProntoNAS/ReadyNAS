# 
# ***** BEGIN LICENSE BLOCK *****
# Source last modified: $Id: cvs.py,v 1.1.1.1 2006/03/29 16:45:39 hagi Exp $
# 
...
class UNIXCVS(CVS):
    ...
    def Cmd(self, cmd, path, dir = None):
        ...
        outmsg.verbose("running %s in %s + %s" % (repr(cmd), repr(os.getcwd()), repr(dir)))
        return shell.run(cmd, dir = dir)
