...
#define TDMA_CONTROL		0x0840
#define		TDMA_CONTROL_NOO	(3<<16)
#define		TDMA_CONTROL_ACT	(1<<14)
#define		TDMA_CONTROL_FETCHND	(1<<13)
#define		TDMA_CONTROL_ENABLE	(1<<12)
#define		TDMA_CONTROL_BS		(1<<11)
#define		TDMA_CONTROL_CHAIN	(1<<9)
#define		TDMA_CONTROL_SBLIMIT	(3<<8)
#define		TDMA_CONTROL_ORE	(1<<4)
#define		TDMA_CONTROL_DBLIMIT	(7<<0)
#define		TDMA_CONTROL_DBLIMIT32	(3<<0)
#define		TDMA_CONTROL_DBLIMIT128	(4<<0)
#define TDMA_BYTE_COUNT		0x0800
#define		TDMA_BYTE_COUNT_OWN	(1<<31)
#define		TDMA_BYTE_COUNT_MASK	0x0FFF
#define TDMA_SRC_ADDR		0x0810
#define TDMA_DEST_ADDR		0x0820
#define TDMA_NEXT_DESC		0x0830
#define TDMA_CURR_DESC		0x0870
