...
int ahci_reset_controller(struct ata_host *host)
{
	...
	if (!ahci_skip_host_reset) {
		...
		{
			writel(0x00000104, mmio + 0x00000178);
			writel(0x00500B03, mmio + 0x0000017c);
			writel(0x00000104, mmio + 0x000001f8);
			writel(0x00500B03, mmio + 0x000001fc);
			writel(0x00000104, mmio + 0x00000278);
			writel(0x00500B03, mmio + 0x0000027c);
			writel(0x00000104, mmio + 0x000002f8);
			writel(0x00500B03, mmio + 0x000002fc);
		}
#endif
	} else
