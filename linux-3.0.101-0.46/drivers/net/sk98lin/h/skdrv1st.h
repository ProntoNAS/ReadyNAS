 ...
 */
#define USE_ALT_TIMING

#ifndef	SK_LITTLE_ENDIAN
#define SWITCH_32(value)	(value)

#define	SWITCH_16(x)	(x)
#else
#define SWITCH_32(value)					\
	((((value)<<24L) & 0xff000000L) +	\
	 (((value)<< 8L) & 0x00ff0000L) +	\
	 (((value)>> 8L) & 0x0000ff00L) +	\
	 (((value)>>24L) & 0x000000ffL))
	 
#define	SWITCH_16(x)	((((x)<<8)&0xff00) + (((x)>>8)&0x00ff))
#endif
#endif
