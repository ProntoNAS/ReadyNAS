...
#define	VPD_CTRL						0x00B8	/* 32 bit	EEPROM and OTP
												 ...
												 */
                                                /* Yukon-Supreme */
#define	FLASH_LDR_CTRL					0x00A4	/* 32 bit	Flash Loader */
                                                /* Yukon-Supreme */
#define	LD_STATUS_0						0x00A8	/* 32 bit	LOADER STATUS */
                                                /* Yukon-Supreme */
#define	VPD_FLASH_CTRL					0x00B8	/* 32 bit	EEPROM and Flash
												 *			Control Register
												 */
...
#define	PCI_ERBAR_BASE_MSK				SHIFT17(0x7fff)	/* ROM Base Address MSb */
...
#define	PCI_OUR1_PAGE_SEL_MSK			SHIFT16(0x7)	/* Page Register[2:0] */
...
#define	PCIE_OUR_STAT_DLL_ERR_MSK			SHIFT24(0x3)	
#define	PCIE_OUR_STAT_DLL_ERR_BASE			24
/* DLL Row Counters Values */
#define	PCIE_OUR_STAT_DLL_ROW_MSK			SHIFT20(0xf)	
#define	PCIE_OUR_STAT_DLL_ROW_BASE			20
/* DLL Column Counters Values */
#define	PCIE_OUR_STAT_DLL_COL_MSK			SHIFT16(0xf)	
...
#define	PCIE_OUR3_DIS_CLK_WOL_GMAC				BIT_27          /* Yukon-Supreme */			
/*		Bit(s) PCIE_OUR3_RSRV_26_21 reserved */
/* Disable clk_clk for ASF Flash */
#define	PCIE_OUR3_CLK_FLASH_DIS					BIT_20			/* Yukon-Supreme */
/* Disable clk_clk for USB */
#define	PCIE_OUR3_CLK_USB_DIS					BIT_19          /* Yukon-Supreme */
/* Disable clk_clk for USB */
...
/*		Bit(s) PCIE_OUR5_RSRV_31 reserved */
...
#define	CONFIG_REG0_RTC_MSK							SHIFT24(0xff)	/* RTC Timing */
#define	CONFIG_REG0_RTC_BASE						24
#define	CONFIG_REG0_WTC_MSK							SHIFT16(0xff)	/* WTC Timing */
...
#define	CONFIG_REG0_CLK_RUN_ASF						BIT_13			/* Yukon-Supreme */
/* Enable clock free running for Flash subsystem */
#define	CONFIG_REG0_CLK_RUN_FLASH					BIT_12			/* Yukon-Supreme */
...
/* Testmode Select */
#define	CONFIG_REG1_TESTMODE_SEL_MSK				SHIFT28(0x7)	
...
#define	PSM_CONFIG_REG1_UART_MODE_MSK				SHIFT29(0x3)	/* UART_Mode */
...
#define	FLASH_LDR_CTRL_FLASH_ADDR_MSK				SHIFT16(0x3fff)	
...
#define	VPD_FLASH_CTRL_TWSI_IF_TIMEOUT_MSK			SHIFT17(0x7)	
...
#define	DEVICE_CAPABILITIES_SPL_SCALE_MSK			SHIFT26(0x3)	
#define	DEVICE_CAPABILITIES_SPL_SCALE_BASE			26
/* Captured Slot Power Limit Value */
#define	DEVICE_CAPABILITIES_SPL_VAL_MSK				SHIFT18(0xff)	
...
#define	PCIE_ACKTIM_X1_RPLYTO_MSK		SHIFT16(0xffff)	
...
#define	RBMU_ADDR_HI		0x0408	/* 32 bit	Receive Buffer Address Low
									 *			Register
									 */
#define	RBMU_ADDR_LO		0x040C	/* 32 bit	Receive Buffer Address High
									 *			Register
									 */
...
#define	PKT_GEN_CTL			0x0800	/* 32 bit	Packet Generator Control
                                     *			Register
									 */
#define	PKT_GEN_LEN_CTRL	0x0804	/* 32 bit	Packet Generator Length Register */
...
#define	PKT_GEN_PAT2_HI		0x081C	/* 32 bit	Packet Generator Pattern 2 Hi
									 *			Register
									 */
#define	PKT_GEN_SIZE_LIMIT	0x0820	/* 32 bit	Packet Generator Packet Size
									 *			Limit Register
									 */
...
#define	PKT_GEN_PKT_GAP		0x0828	/* 32 bit	Packet Generator Packet Gap
									 *			Register
									 */
#define	PKT_CHK_PFU_START	0x0830	/* 32 bit	Packet Checker RX PFU Start
									 *			Address Register
									 */
#define	PKT_CHK_BUF_INC		0x0834	/* 32 bit	Packet Checker RX PFU Buffer
									 *			Increment Register
									 */
#define	PKT_CHK_BUF_SIZE	0x0838	/* 32 bit	Packet Checker RX PFU Buffer
									 *			Size Register
									 */
#define	PKT_CHK_ST			0x083C	/* 32 bit	Packet Checker Status Register */
...
#define	SPI_CTRL_SPI_CLK_RATE_MSK		SHIFT26(0x3)	/* SPI CLK rate selection */
...
#define	SPI_LCFG_NRML_ADDR_MSK			SHIFT16(0xfff)	
...
#define	SPI_VCFG_VPD_END_MSK			SHIFT16(0xfff)	/* VPD end address */
...
#define	CFG_MADDR_HI_VAL_3_MSK		SHIFT24(0xff)	/* Mac-Address_x, Byte 3 */
#define	CFG_MADDR_HI_VAL_3_BASE		24
#define	CFG_MADDR_HI_VAL_2_MSK		SHIFT16(0xff)	/* Mac-Address_x, Byte 2 */
...
#define	ASF_TO_0_3_ASF_TO3_MSK		SHIFT24(0xff)	/* Timeout Value 3 */
#define	ASF_TO_0_3_ASF_TO3_BASE		24
#define	ASF_TO_0_3_ASF_TO2_MSK		SHIFT16(0xff)	/* Timeout Value 2 */
...
#define	FCU_MEM_CTRL_OP_SIZE_MSK				SHIFT24(0x7)	/* Operation Size */
...
#define	FLASH_MEM_CMD_CMD_CODE_MSK			SHIFT16(0xff)	
...
#define	FLASH_MEM_STATUS_CONFIG_VAL_MSK			SHIFT16(0xff)	/* Config Data */
 ...
 *								(indirect access)
 */
#define	FLASH_MEM_PWR_PARA_RST_WIDTH_MSK			SHIFT16(0xffff)	/* Reset Width */
 ...
 */
#define	FLASH_MEM_WD_SOFT_RST_WIDTH_MSK			SHIFT16(0xffff)	/* Soft Reset Width */
...
/*	RBMU_ADDR_HI		0x0408	Receive Buffer Address Low Register */
#define	RBMU_ADDR_HI_MSK		SHIFT0(0xffffffff)	/* Receive Buffer Address Low */
#define	RBMU_ADDR_HI_BASE		0

/*	RBMU_ADDR_LO		0x040C	Receive Buffer Address High Register */
#define	RBMU_ADDR_LO_MSK		SHIFT0(0xffffffff)	/* Receive Buffer Address High */
...
#define	RBMU_TEST_EOP_BUSY_DLY_MSK			SHIFT28(0x3)	/* EOP Busy Delay */
...
/* Home Address Paddiing FIX1 Enable */
#define	TBMU_TEST_HOME_ADD_PAD_FIX1_EN		BIT_29	
/* Home Address Paddiing FIX1 Disable */
...
#define	PKT_GEN_CTL_PKT_GEN_DIS				BIT_0				/* Packet Gen Reset */
...
#define	PKT_GEN_DELTA_LEN_MSK				SHIFT16(0x7ff)	
...
#define	PKT_GEN_SIZE_LIMIT_PKT_GEN_LEN_MIN_MSK		SHIFT16(0x7ff)	
...
#define	PKT_CHK_BUF_INC_PKT_CHK_PFU_PUTIDX_INC_MSK		SHIFT25(0x7f)	
#define	PKT_CHK_BUF_INC_PKT_CHK_PFU_PUTIDX_INC_BASE		25
/* Packet Checker RX LE Buffer Length Increment */
#define	PKT_CHK_BUF_INC_PKT_CHK_PFU_BUFLEN_INC_MSK		SHIFT14(0x7ff)	
...
#define	PKT_CHK_BUF_SIZE_PKT_CHK_PFU_BUFLEN_MAX_MSK			SHIFT16(0x3fff)	
...
/*	PKT_CHK_ST			0x083C	Packet Checker Status Register */
/* Packet Checker Packet Number */
#define	PKT_CHK_ST_PKT_CHK_PKTNUM_MSK		SHIFT16(0xffff)	
...
#define	RXMF_ULTH_LO_TH_MSK				SHIFT16(0x7ff)	
...
#define	RXMF_FCNT_BLANK_31_16_MSK		SHIFT16(0xffff)	/* ASF Flush Counter */
...
#define	SMB_CFG_PS_MSK			SHIFT30(0x3)	/* SMBus Prescaler Bits */
#define	SMB_CFG_PS_BASE			30
#define	SMB_CFG_CSE				BIT_29			/* SMBus Clock Stretching Enable */
#define	SMB_CFG_BR_MSK			SHIFT16(0x1fff)	/* SMBus Bit Rate */
...
#define	HCU_MAP_BASE_MSK				SHIFT12(0xfffff)	
...
#define	CPU_AHB_CTRL_SET_JTAG_TEST_MSK		SHIFT24(0x3)	/* CPU's JTAG Test Mode */
...
#define	HCU_CCSR_AHB_BRIDGE_SWITCH_MSK		SHIFT30(0x3)	
#define	HCU_CCSR_AHB_BRIDGE_SWITCH_BASE		30
/* USB AHB Bridge Switch */
#define	HCU_CCSR_USB_BRIDGE_SWITCH_MSK		SHIFT28(0x3)	
...
#define	HCU_HCSR_CPU_RST_WDOG_TIMER_MSK			SHIFT24(0xff)	
...
/* Yukon-Supreme */
#define	PHY_CFG_REG25_SEL_MSK			SHIFT17(0x3)	/* Reg25 Sel */
...
#define	WOL_PLEN2_P11_LEN_MSK		SHIFT24(0x7f)	/* Pattern 11 Length */
#define	WOL_PLEN2_P11_LEN_BASE		24
/*		Bit(s) WOL_PLEN2_RSRV_23 reserved */
#define	WOL_PLEN2_P10_LEN_MSK		SHIFT16(0x7f)	/* Pattern 10 Length */
...
#define	WOL_PCNT2_P11_CNTR_MSK		SHIFT24(0x7f)	/* Pattern 11 Counter */
#define	WOL_PCNT2_P11_CNTR_BASE		24
/*		Bit(s) WOL_PCNT2_RSRV_23 reserved */
#define	WOL_PCNT2_P10_CNTR_MSK		SHIFT16(0x7f)	/* Pattern 10 Counter */
...
#define	PAT_P12PPMDR0_PMP1_MSK		SHIFT16(0xffff)	/* Port Match Pattern 1 */
...
#define	PAT_P12PPMDR1_PMP3_MSK		SHIFT16(0xffff)	/* Port Match Pattern 3 */
...
#define	PAT_P12PPMDR2_PMP5_MSK		SHIFT16(0xffff)	/* Port Match Pattern 5 */
...
#define	PAT_P12PPMDR3_PMP7_MSK		SHIFT16(0xffff)	/* Port Match Pattern 7 */
...
#define	PAT_P13PPMDR0_PMP1_MSK		SHIFT16(0xffff)	/* Port Match Pattern 1 */
...
#define	PAT_P13PPMDR1_PMP3_MSK		SHIFT16(0xffff)	/* Port Match Pattern 3 */
...
#define	PAT_P13PPMDR2_PMP5_MSK		SHIFT16(0xffff)	/* Port Match Pattern 5 */
...
#define	PAT_P13PPMDR3_PMP7_MSK		SHIFT16(0xffff)	/* Port Match Pattern 7 */
...
#define	THDR1_HI_IP_HDR_0_MSK		SHIFT16(0xffff)	/* Word 0 of IPv4/IPv6 Header */
...
#define	THDR22_HI_TCP_HDR_0_MSK			SHIFT16(0xffff)	/* Word 0 of TCP Header */
...
#define	USB_CTRL2_UDU2_IP_REV_ID_MSK		SHIFT16(0xffff)	/* UDU2 IP Rev ID */
...
#define	USB_IP_REV_IP_REV_MSK			SHIFT16(0xffff)	/* udu2_phy_ip_rev */
...
#define	USB_PHY_CTRL_CTL_IPG_MSK			SHIFT30(0x3)	/* usb_ctl_ipg */
#define	USB_PHY_CTRL_CTL_IPG_BASE			30
#define	USB_PHY_CTRL_CTL_IPG_SOF_MSK		SHIFT28(0x3)	/* usb_ctl_ipg_sof */
...
#define	USB_PHY_PLL_VPLLCAL_MSK			SHIFT25(0x3)	/* VPLLCAL */
...
#define	USB_PHY_PLL_VR_CPBUF_MSK		SHIFT19(0x3)	/* VR_CPBUF[1:0] */
#define	USB_PHY_PLL_VR_CPBUF_BASE		19
#define	USB_PHY_PLL_LOCKDET_ISEL		BIT_18			/* LOCKDET_ISEL */
#define	USB_PHY_PLL_KVCO_MSK			SHIFT15(0x7)	/* KVCO[2:0] */
...
#define	USB_PHY_TX_TXVDRV_MSK			SHIFT22(0x3)	/* TXVDRV */
#define	USB_PHY_TX_TXVDRV_BASE			22
#define	USB_PHY_TX_TXDATA_BLOCK_EN		BIT_21			/* TXDATA_BLOCK_EN */
#define	USB_PHY_TX_CK60_PHSEL_MSK		SHIFT17(0xf)	/* CK60_PHSEL */
#define	USB_PHY_TX_CK60_PHSEL_BASE		17
#define	USB_PHY_TX_IMPCAL_VTH_MSK		SHIFT14(0x7)	/* IMPCAL_VTH[2:0] */
...
#define	USB_PHY_RX_RXDATA_BLOCK_LENGTH_MSK		SHIFT28(0x3)	
#define	USB_PHY_RX_RXDATA_BLOCK_LENGTH_BASE		28
#define	USB_PHY_RX_EDGE_DET_EN					BIT_27			/* EDGE_DET_EN */
/* S2TO3_DLY_SEL[1:0] */
#define	USB_PHY_RX_S2TO3_DLY_SEL_MSK			SHIFT25(0x3)	
...
/* REG_ACQ_LENGTH[1:0] */
#define	USB_PHY_RX_REG_ACQ_LENGTH_MSK			SHIFT17(0x3)	
#define	USB_PHY_RX_REG_ACQ_LENGTH_BASE			17
/* REG_SQ_LENGTH[1:0] */
#define	USB_PHY_RX_REG_SQ_LENGTH_MSK			SHIFT15(0x3)	
...
/* REG_FIFO_FILL_NUM */
#define	USB_PHY_TEST_GRP_0_FIFO_FILL_NUM_MSK		SHIFT21(0xf)	
...
#define	USB_PHY_TEST_GRP_1_PAD_STRENGTH_MSK			SHIFT25(0x1f)	
#define	USB_PHY_TEST_GRP_1_PAD_STRENGTH_BASE		25
/* REG_MON_SEL[3:0] */
#define	USB_PHY_TEST_GRP_1_MON_SEL_MSK				SHIFT21(0xf)	
#define	USB_PHY_TEST_GRP_1_MON_SEL_BASE				21
/* REG_TEST_DIG_LPBK */
#define	USB_PHY_TEST_GRP_1_TEST_DIG_LPBK			BIT_20			
/* REG_TEST_SKIP[2:0] */
#define	USB_PHY_TEST_GRP_1_TEST_SKIP_MSK			SHIFT17(0x7)	
...
#define	USB_PHY_TEST_GRP_2_TEST_FIFO_R_PNT_MSK		SHIFT16(0xffff)	
...
#define	USB_PHY_ID_GRP_RESERVE_MSK		SHIFT16(0x3ff)	/* RESERVE[9:0] */
...
#define	USB_INT2_DEG_MON_MSK		SHIFT16(0xffff)	/* USB Debug MON */
...
#define	USB_EP_LISTADDR_EPBASE_MSK			SHIFT11(0x1fffff)	/* EPBASE[31:11] */
...
#define	USB_ENDPTPRIME_PETB_MSK				SHIFT16(0x3f)	/* PETB [5:0] */
...
#define	USB_ENDPTFLUSH_FETB_MSK				SHIFT16(0x3f)	/* FETB [5:0] */
...
#define	USB_ENDPTSTAT_ETBR_MSK				SHIFT16(0x3f)	/* ETBR [5:0] */
...
#define	USB_EP_COMPL_ETCE_MSK				SHIFT16(0x3f)	/* ETCE [5:0] */
...
#define	SIU_CPR_FIFO_MODE_MSK				SHIFT16(0xff)	/* FIFO_MODE */
