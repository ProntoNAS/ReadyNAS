				     ...
				     bool locked)
{
	...
	if (offset > MAX_PHY_MULTI_PAGE_REG)
		ret_val = igb_write_phy_reg_mdic(hw,
						   ...
						   (u16)offset);
	if (!ret_val)
		ret_val = igb_write_phy_reg_mdic(hw, MAX_PHY_REG_ADDRESS &
						       offset,
						   data);
	if (!locked)
		hw->phy.ops.release(hw);
...
s32 igb_write_phy_reg_gs40g(struct e1000_hw *hw, u32 offset, u16 data)
{
	...
	DEBUGFUNC("igb_write_phy_reg_gs40g");
...
s32 igb_read_phy_reg_gs40g(struct e1000_hw *hw, u32 offset, u16 *data)
{
	...
	DEBUGFUNC("igb_read_phy_reg_gs40g");
...
/**
 *  igb_read_phy_reg_mphy - Read mPHY control register
 *  @hw: pointer to the HW structure
...
s32 igb_read_phy_reg_mphy(struct e1000_hw *hw, u32 address, u32 *data)
{
	...
	DEBUGFUNC("igb_read_phy_reg_mphy");
...
/**
 *  igb_write_phy_reg_mphy - Write mPHY control register
 *  @hw: pointer to the HW structure
			     ...
			     bool line_override)
{
	...
	DEBUGFUNC("igb_write_phy_reg_mphy");
