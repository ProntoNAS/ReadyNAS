...
#endif /* CONFIG_MV_ETH_RX_DESC_PREFETCH */
/*
		MV_CPU_CNTRS_STOP(event0);
		MV_CPU_CNTRS_SHOW(event0);
		MV_CPU_CNTRS_START(event0);
*/
		rx_done++;
		rx_filled++;
...
static void mv_eth_cpu_counters_init(void)
{
	...
	mvCpuCntrsProgram(0, MV_CPU_CNTRS_CYCLES, "Cycles", 34);

	/* instruction counters */
	mvCpuCntrsProgram(1, MV_CPU_CNTRS_INSTRUCTIONS, "Instr", 24);
	...
	event0 = mvCpuCntrsEventCreate("EMPTY", 100000);
	event1 = mvCpuCntrsEventCreate("GMAC_RX", 100000);
	event2 = mvCpuCntrsEventCreate("GMAC_RX_REFILL", 100000);
	event3 = mvCpuCntrsEventCreate("LINUX_PROC", 100000);
	event4 = mvCpuCntrsEventCreate("GMAC_TX", 100000);
	event5 = mvCpuCntrsEventCreate("GMAC_TX_DONE", 100000);
	event6 = mvCpuCntrsEventCreate("GMAC_ISR", 100000);
	if ((event0 == NULL) || (event1 == NULL) || (event2 == NULL) ||
		(event3 == NULL) || (event4 == NULL) || (event5 == NULL) || (event6 == NULL))
