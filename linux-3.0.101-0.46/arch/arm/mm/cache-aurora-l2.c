...
static unsigned char *wsize[]={   "reserved",
                                  "reserved",
                                  "16KB",
                                  "32KB",
                                  "64KB",
...
static void __init enable_l2(void)
{
	...
	if (!(u & 1)) {
		printk(KERN_INFO "Aurora: Enabling L2\n");
		u |= 1;
...
int __init aurora_l2_init(void __iomem *base)
{
	...
	printk(KERN_INFO "AuroraL2: System L2 cache support initialised\n");
