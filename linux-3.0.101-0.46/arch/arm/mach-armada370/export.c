...
#include "cpu/mvCpuCntrsIf.h"
EXPORT_SYMBOL(mvCpuCntrsEventCreate);
EXPORT_SYMBOL(mvCpuCntrsEventDelete);
EXPORT_SYMBOL(mvCpuCntrsShow);
EXPORT_SYMBOL(mvCpuCntrsEventClear);
EXPORT_SYMBOL(mvCpuCntrsReadAfter);
EXPORT_SYMBOL(mvCpuCntrsReadBefore);
