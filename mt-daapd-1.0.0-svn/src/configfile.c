/*
 * $Id: configfile.c,v 1.1.1.1 2010-09-22 17:14:54 jmaggard Exp $
...
#if 1 // Allow null passwords for Firefly configuration.
            return FALSE;
#else
...
#if 0 // Allow null passwords for Firefly configuration.
...
#ifdef WITH_AVAHI
    ws_writefd(pwsc,"%s ","--enable-avahi");
#endif
