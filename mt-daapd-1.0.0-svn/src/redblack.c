static char rcsid[]="$Id: redblack.c,v 1.1.1.1 2010-09-22 17:14:54 jmaggard Exp $";
...
/*
 * $Log: redblack.c,v $
 * Revision 1.1.1.1  2010-09-22 17:14:54  jmaggard
 * Reimport.
 *
 * Revision 1.2  2007-06-14 01:40:06  jmaggard
 * - Update to upstream SVN snapshot 1586.
 *
 * Revision 1.1.1.1  2006-12-13 02:02:07  jmaggard
 * Check in vanilla mt-daapd (now FireFly) SVN snapshot 1433.
 *
