/*
 * $Id: main.c,v 1.1.1.1 2010-09-22 17:14:54 jmaggard Exp $
...
int main(int argc, char *argv[]) {
...
#if 0 //JM: Don't do this on ReadyNAS platform.
...
#else //JM: Do it after startup instead.
    ...
    if(conf_get_int("general","rescan_interval",0) && (!reload) &&
       (!conf_get_int("scanning","skip_first",1)))
        config.reload = 1; /* force a reload on start */
