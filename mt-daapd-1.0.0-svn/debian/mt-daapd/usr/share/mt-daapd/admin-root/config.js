...
var ConfigXML = {
  ...
  parseXML: function(xmlDoc) {
    $A(xmlDoc.getElementsByTagName('section')).each(function (section) {
      if (section.getAttribute('hidden') == 'true') {
        return;
      }
...
//        frag.appendChild(Builder.node('br'));
    ...
    if ( (!Cookie.getVar('show_advanced_config') && item.advanced) || item.hidden) {
...
var BuildElement = {
  input: function(id,name,displayName,value,size,short_description,long_description,disable) {
