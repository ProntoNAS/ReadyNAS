...
gint _vala_main (gchar** args, int args_length1) {
	...
	GError * _inner_error_ = NULL;
	{
		...
		TestApp* _tmp3_;
		gint _tmp4_;
#line 8 "/home/carlos/Source/gnome/tracker-1.12/tests/functional-tests/ipc/test-bus-update.vala"
...
#line 8 "/home/carlos/Source/gnome/tracker-1.12/tests/functional-tests/ipc/test-bus-update.vala"
		app = _tmp2_;
#line 10 "/home/carlos/Source/gnome/tracker-1.12/tests/functional-tests/ipc/test-bus-update.vala"
		_tmp3_ = app;
#line 10 "/home/carlos/Source/gnome/tracker-1.12/tests/functional-tests/ipc/test-bus-update.vala"
...
#line 71 "test-bus-update.c"
	...
	__catch7_g_error:
	{
		...
		GError* _tmp5_;
		const gchar* _tmp6_;
#line 7 "/home/carlos/Source/gnome/tracker-1.12/tests/functional-tests/ipc/test-bus-update.vala"
		e = _inner_error_;
#line 7 "/home/carlos/Source/gnome/tracker-1.12/tests/functional-tests/ipc/test-bus-update.vala"
		_inner_error_ = NULL;
#line 12 "/home/carlos/Source/gnome/tracker-1.12/tests/functional-tests/ipc/test-bus-update.vala"
		_tmp5_ = e;
#line 12 "/home/carlos/Source/gnome/tracker-1.12/tests/functional-tests/ipc/test-bus-update.vala"
		_tmp6_ = _tmp5_->message;
#line 12 "/home/carlos/Source/gnome/tracker-1.12/tests/functional-tests/ipc/test-bus-update.vala"
		g_warning ("test-bus-update.vala:12: Couldn't perform test: %s", _tmp6_);
#line 13 "/home/carlos/Source/gnome/tracker-1.12/tests/functional-tests/ipc/test-bus-update.vala"
		result = 1;
#line 13 "/home/carlos/Source/gnome/tracker-1.12/tests/functional-tests/ipc/test-bus-update.vala"
		_g_error_free0 (e);
#line 13 "/home/carlos/Source/gnome/tracker-1.12/tests/functional-tests/ipc/test-bus-update.vala"
...
int main (int argc, char ** argv) {
	...
	g_type_init ();
#endif
#line 4 "/home/carlos/Source/gnome/tracker-1.12/tests/functional-tests/ipc/test-bus-update.vala"
