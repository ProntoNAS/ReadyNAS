...
static int run(mddev_t *mddev)
{
	...
	if (mddev->reshape_position != MaxSector) {
		...
		//old_disks sometimes don't get correct info becasue of compiler optimization
		//we force old_disks to get the value again here;
		printk(KERN_INFO"raid_disks:%d; delta_disks:%d; old_disks:%d\n" \
			,mddev->raid_disks,mddev->delta_disks,old_disks);
