...
/* $Id: aha1542.h,v 1.1.1.1 2011/05/31 01:44:01 libo Exp $
 *
 * Header file for the adaptec 1542 driver for Linux
 *
 * $Log: aha1542.h,v $
 * Revision 1.1.1.1  2011/05/31 01:44:01  libo
 * This kernel which derived from kernel-2.6.31-topkick1281p2 used for both Netgear DUOv3 and NV+v4. It is based on kernel 2.6.31.8 and Marvell 5.1.3 patch. Specially the USB3.0 driver come from kernel 2.6.39.
 *
