...
const char * const cmd_check_usage[] = {
	...
	"--ignore-fsid-mismatch      allow the check to proceed with a fsid mismatch",
...
int cmd_check(int argc, char **argv)
{
	...
	while(1) {
		...
		enum { GETOPT_VAL_REPAIR = 257, GETOPT_VAL_INIT_CSUM,
			...
			GETOPT_VAL_FORCE, GETOPT_VAL_IGNORE_FSID_MISMATCH };
		static const struct option long_options[] = {
			...
			{ "ignore-fsid-mismatch", no_argument, NULL,
				GETOPT_VAL_IGNORE_FSID_MISMATCH },
		...
		switch(c) {
			...
			case GETOPT_VAL_INIT_EXTENT:
				...
				repair = 1;
				break;
			case GETOPT_VAL_IGNORE_FSID_MISMATCH:
				printf("ignoring fsid mismatches\n");
