...
extern void wizd_filesread_update(HTTP_RECV_INFO *http_recv_info_p, off_t content_length, off_t written, int titleid);
...
# endif
	...
	wizd_filesread_update(http_recv_info_p, joint_content_length, written, titleid);
