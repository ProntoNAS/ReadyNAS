 ...
 *
 *	$Log: skgepnm2.h,v $
 *	Revision 2.8  2010/03/23 16:22:33  tschilli
 *	Added missing PNMI chipset defines used for pAC->Pnmi.Chipset in SkPnmiInit().
 *
 *	Revision 2.7  2009/10/27 08:24:08  tschilli
 *	Added changes to support compilation without RMLT (SK_NO_RLMT)
 *
 *	Revision 2.6  2007/01/17 15:15:23  rschmidt
 *	Editorial changes
 *
 *	Revision 2.5  2005/12/14 16:11:19  ibrueder
 *	Added copyright header flags
 *
 *	Revision 2.4  2005/05/03 06:42:43  tschilli
 *	Added missing defines for OID_SKGE_CHIPSET.
 *
 *	Revision 2.3  2004/03/19 16:19:59  tschilli
 *	Merged the changes of revision 1.37.
 *
 *	Revision 2.2  2003/11/24 13:27:37  mkarl
 *	Semicolon added after SK_DBG_MSG.
 *
 ...
 *
 *	Revision 1.37  2004/01/02 12:01:22  rschmidt
 *	Editorial changes.
 *
 ...
 *	the granularity of 32 for the port switch estimate counter.
 *
 ...
 *	Defined macro SK_PNMI_DEF_RLMT_CHG_THRES for default port switch threshold.
 *
 ...
 *	Fixed alignment problem in SK_PNMI_SET_STAT macro.
 *
 ...
 *	Fixed mismatched calculation of SK_PNMI_HUNDREDS_SEC.
 *
...
#define SK_PNMI_CHIPSET_YUKON_FE_P	8	/* YUKON-2 FE+ */
#define SK_PNMI_CHIPSET_YUKON_EC_U	9	/* YUKON-2 EC Ultra */
#define SK_PNMI_CHIPSET_YUKON_EX	10	/* YUKON-2 Extreme */
#define SK_PNMI_CHIPSET_YUKON_SUPR	11	/* YUKON-2 Supreme */
#define SK_PNMI_CHIPSET_YUKON_UL_2	12	/* YUKON-2 Ultra 2 */
#define SK_PNMI_CHIPSET_YUKON_OPT	13	/* YUKON-2 Optima */
#define SK_PNMI_CHIPSET_YUKON_PRM	14	/* YUKON-2 Optima Prime */
