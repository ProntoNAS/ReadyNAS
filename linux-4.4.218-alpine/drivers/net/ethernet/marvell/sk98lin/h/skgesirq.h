/******************************************************************************
 *
 * Name:	$Id: //Release/Yukon_1G/Shared/common/V6/h/skgesirq.h#6 $
...
#define SK_HWEV_PAUSE_PACKET	11	/* Pause Packet Handling */
...
#define SK_PAUSE_PKT_TIME	  30000UL	/*   30 msec */

/*
 * Define the error numbers and messages
 */
#define SKERR_SIRQ_E001		(SK_ERRBASE_SIRQ+1)
...
#define SKERR_SIRQ_E037		(SKERR_SIRQ_E036+1)
#define SKERR_SIRQ_E037MSG	"Unexpected IRQ from 2nd port"
