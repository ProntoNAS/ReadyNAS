...
#define serial2_echo_outb(v,a) outb((v),(a)+0x2f8)
#define serial2_echo_inb(a)    inb((a)+0x2f8)
...
#define WAIT_FOR_2XMITR \
 do { \
       lsr = serial2_echo_inb(UART_LSR); \
 } while ((lsr & BOTH_EMPTY) != BOTH_EMPTY)
