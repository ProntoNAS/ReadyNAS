...
#endif
	{	IH_OS_FREERTOS,	"freertos",	"FreeRTOS",		},
	{	-1,		"",		"",			},
};
...
{
	char	*s;
	ulong	initrd_high = ~0; /* no restrictions to load high */
	int	initrd_copy_to_ram = 0;
	...
	if (rd_data) {
		if (!initrd_copy_to_ram) {	/* zero-copy ramdisk support */
			...
			*initrd_end = rd_data + rd_len;
			...
			printf("   Using Ramdisk in place at %08lx, end %08lx\n",
