...
extern int ext2fs_devread (lbaint_t sector, int byte_offset, int byte_len,char *buf);
extern lbaint_t ext2fs_set_blk_dev(block_dev_desc_t *rbdd, int part);
extern int ext2fs_ls (const char *dirname, char *outbuff, int outsize);
extern int ext2fs_open (const char *filename);
extern int ext2fs_read (char *buf, unsigned len);
extern int ext2fs_mount (lbaint_t part_length);
