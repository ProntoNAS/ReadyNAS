...
/************/
#ifdef NETGEAR_RN102
#define CONFIG_IDENT_STRING	" Marvell version: v2011.12 2014_T2.0p1 \n06/23/2015 ReadyNAS-102 V2.0"
#elif defined(NETGEAR_RN104)
#define CONFIG_IDENT_STRING	" Marvell version: v2011.12 2014_T2.0p1 \n06/23/2015 ReadyNAS-104 V2.0"
#elif defined(NETGEAR_RN25)
#define CONFIG_IDENT_STRING	" Marvell version: v2011.12 2014_T2.0p1 \n06/23/2015 ReadyNAS-25 V2.0"
#endif
...
#ifdef CONFIG_SCSI_MV92XX
#define CONFIG_LIBATA
#define CONFIG_SCSI_AHCI
#define CONFIG_SCSI_MAX_CONTROLLERS	4 /* based on MV_PEX_MAX_UNIT */
#define CONFIG_SYS_SCSI_MAX_SCSI_ID	(4 * CONFIG_SCSI_MAX_CONTROLLERS)
#define CONFIG_SYS_SCSI_MAX_LUN		1
#define CONFIG_SYS_SCSI_MAX_DEVICE	(CONFIG_SYS_SCSI_MAX_SCSI_ID * CONFIG_SYS_SCSI_MAX_LUN)
#define CONFIG_SCSI_DEV_LIST		{ 0x1B4B, 0x9215 }, { 0, 0 }
#endif /* CONFIG_SCSI_MV92XX */

/* #define CONFIG_SATA_6121 */
#ifdef CONFIG_SATA_6121
	#define CONFIG_SCSI_AHCI
...
#define CONFIG_IPADDR		192.168.82.234
#define CONFIG_SERVERIP		192.168.82.150
...
#define CONFIG_UBOOT_SIZE		0x180000
#define CONFIG_SPARE_AREA		0x0000
//libolibo test
...
#define CONFIG_ENV_OFFSET_NAND		0x180000	/* environment starts here  */
...
#define CONFIG_EXTRA_ENV_SETTINGS               \
	...
	"AC_Power_fail_detect=open\0"           \
	"Manufacturer=NETGEAR\0"                \
	"Version=V1.0\0"                        \
	"NANDboot=nand read.e 0x2000000 0x200000 0x400000;nand read.e 0x1000000  0x7e00000 0x20000;nand read.e  0x3000000 0x800000 0x400000;bootz 0x2000000 0x3000000 0x1000000\0"					\
	"check_usb=usb start; fatload usb 0:1 0x2000000 /NTGR_USBBOOT_INFO.txt\0"	\
	""
#define	RN102_ENV	\
	"Product=ReadyNAS 102\0"                \
	"SKUNum=RN102\0"                        \
	"USBboot=fatload usb 0:1 0x2000000 /zImage-recovery;fatload usb 0:1 0x1000000 /RN102-recovery.dtb;fatload usb 0:1 0x3000000 /initrd-recovery.gz;bootz 0x2000000 0x3000000 0x1000000\0"                          \
	""
#define	RN104_ENV	\
	"Product=ReadyNAS 104\0"                \
	"SKUNum=RN104\0"                        \
	"USBboot=fatload usb 0:1 0x2000000 /zImage-recovery;fatload usb 0:1 0x1000000 /RN104-recovery.dtb;fatload usb 0:1 0x3000000 /initrd-recovery.gz;bootz 0x2000000 0x3000000 0x1000000\0"                          \
	""
#define	RN25_ENV	\
	"Product=ReadyNAS 25\0"                \
	"SKUNum=RN25\0"                        \
	"USBboot=fatload usb 0:1 0x2000000 /zImage-recovery;fatload usb 0:1 0x1000000 /RN102-recovery.dtb;fatload usb 0:1 0x3000000 /initrd-recovery.gz;bootz 0x2000000 0x3000000 0x1000000\0"                          \
	""
