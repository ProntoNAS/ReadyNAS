...
#if defined(CONFIG_DB_88F6710_BP) || defined(CONFIG_RD_88F6710)
...
#define PEX1_MEM_BASE			0xB2000000
#define PEX1_MEM_SIZE			_32M

#define PEX0_IO_BASE			0xC1100000
#define PEX0_IO_SIZE			_1M
#define PEX1_IO_BASE			0xC1200000
...
/* Important for MP - Do not disable/change this window */
#define CRYPT_ENG_BASE	 0xc8010000
#define CRYPT_ENG_SIZE	 _64K

#define DEVICE_SPI_BASE SPI_CS_BASE

#if (defined(MV_INCLUDE_NOR) && defined(CONFIG_MTD_NAND_NFC)) || defined(MV_NOR_BOOT)
#define DEV_BOOCS_PHYS_BASE NOR_CS_BASE
#define DEV_BOOCS_PHYS_SIZE NOR_CS_SIZE

#define DEVICE_CS0_BASE 0xf5000000
#define DEVICE_CS0_SIZE _16M
#else
#define DEV_BOOCS_PHYS_BASE 0xf5000000
#define DEV_BOOCS_PHYS_SIZE _16M
...
#define MV_CPU_IF_ADDR_WIN_MAP_TBL {									\
	...
	{{DEVICE_CS0_BASE,	0,	DEVICE_CS0_SIZE	},	5,			EN},	/* DEVICE_CS0 */\
	...
	{{DEV_BOOCS_PHYS_BASE,	0,	DEV_BOOCS_PHYS_SIZE	},	9,			EN},	/* DEV_BOOCS */   \
