...
static int do_fix_pex(cmd_tbl_t *cmdtp, int flag, int argc, char * const argv[])
{

		mvPexConfigWrite(0, 0, 0, 0, 0x10, 0x8000000c);

		*(VUL *)0xf1020000 = 0x0fffe841;
		*(VUL *)0xf1020004 = 0x80000000;
		*(VUL *)0xf1020008 = 0x80000000;
		*(VUL *)0xf102000c = 0x00000000;

		*(VUL *)0x80041804 = 0x07ff0001;
		*(VUL *)0x8004001c = 0x00000000;

		mvPexConfigWrite(0, 0, 0, 0, 0x18, 0x8800000c);

		*(VUL *)0x80041824 = 0x88000000;
		*(VUL *)0x80041820 = 0x03ff0031;
		*(VUL *)0x8004182c = 0x00000000;

		*(VUL *)0x80041834 = 0x8c000000;
		*(VUL *)0x80041830 = 0x000f0081;
		*(VUL *)0x8004183c = 0x00000000;

		*(VUL *)0x80020b84 = 0x90000000;
		*(VUL *)0x80020b88 = 0x90000000;
		*(VUL *)0x80020b8c = 0x90000000;

		*(VUL *)0x800218bc = 0x21;
		*(VUL *)0x800218bc = 0x22;
		*(VUL *)0x800218bc = 0x23;

		*(VUL *)0x8800020c = 0xe04;
		*(VUL *)0x88000204 = 0xe4;
		*(VUL *)0x88000254 = 0x6;
		*(VUL *)0x88000210 = 0xffff0000;


		*(VUL *)0x8c0f8014 = *(VUL *)0x8c0f8014  & ~ 0x01;
...
U_BOOT_CMD(
		  fix_pex,      1,     1,      do_fix_pex,
		  " perform init_done and fix_pex on the dfx on bc2.\n",
		  ""
		  );
...
int do_sar_bc2(cmd_tbl_t * cmdtp, int flag, int argc, char * const argv[])
{
		...
		printf("SatR write bootsel  <val> - write ptppll\n");
