...
#define ACC_HOST		(1 << 0)
#define ACC_PORT		(1 << 1)
#define ACC_CONNECT_TIMEOUT	(1 << 2)
#define ACC_PROTOCOL		(1 << 3)
#define ACC_DOMAIN		(1 << 4)
#define ACC_FROM		(1 << 5)
#define ACC_MAILDOMAIN		(1 << 6)
#define ACC_DSN_RETURN		(1 << 7)
#define ACC_DSN_NOTIFY		(1 << 8)
#define ACC_KEEPBCC		(1 << 9)
...
#define ACC_LOGFILE		(1 << 20)
#define ACC_SYSLOG		(1 << 21)
