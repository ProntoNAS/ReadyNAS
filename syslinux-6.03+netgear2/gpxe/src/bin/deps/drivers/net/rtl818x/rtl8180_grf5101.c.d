...
$(BIN)/rtl8180_grf5101.o : drivers/net/rtl818x/rtl8180_grf5101.c $(MAKEDEPS) $(POST_O_DEPS) $(rtl8180_grf5101_DEPS) 
	$(QM)echo "  [BUILD] $@" 
	$(RULE_c)
 
BOBJS += $(BIN)/rtl8180_grf5101.o
 
$(BIN)/rtl8180_grf5101.dbg%.o : drivers/net/rtl818x/rtl8180_grf5101.c $(MAKEDEPS) $(POST_O_DEPS) $(rtl8180_grf5101_DEPS) 
	$(QM)echo "  [BUILD] $@" 
	$(RULE_c_to_dbg%.o)
 
dbg%.o_OBJS += $(BIN)/rtl8180_grf5101.dbg%.o
 
$(BIN)/rtl8180_grf5101.c : drivers/net/rtl818x/rtl8180_grf5101.c $(MAKEDEPS) $(POST_O_DEPS) $(rtl8180_grf5101_DEPS) 
	$(QM)echo "  [BUILD] $@" 
	$(RULE_c_to_c)
 
c_OBJS += $(BIN)/rtl8180_grf5101.c
 
$(BIN)/rtl8180_grf5101.s : drivers/net/rtl818x/rtl8180_grf5101.c $(MAKEDEPS) $(POST_O_DEPS) $(rtl8180_grf5101_DEPS) 
	$(QM)echo "  [BUILD] $@" 
	$(RULE_c_to_s)
 
s_OBJS += $(BIN)/rtl8180_grf5101.s
 
bin/deps/drivers/net/rtl818x/rtl8180_grf5101.c.d : $(rtl8180_grf5101_DEPS)
 
TAGS : $(rtl8180_grf5101_DEPS)
