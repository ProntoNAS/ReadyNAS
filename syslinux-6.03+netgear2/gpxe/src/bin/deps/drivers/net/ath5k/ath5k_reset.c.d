ath5k_reset_DEPS = drivers/net/ath5k/ath5k_reset.c include/compiler.h \
 ...
 arch/i386/include/gpxe/rdtsc_timer.h drivers/net/ath5k/ath5k.h \
...
$(BIN)/ath5k_reset.o : drivers/net/ath5k/ath5k_reset.c $(MAKEDEPS) $(POST_O_DEPS) $(ath5k_reset_DEPS) 
	$(QM)echo "  [BUILD] $@" 
	$(RULE_c)
 
BOBJS += $(BIN)/ath5k_reset.o
 
$(BIN)/ath5k_reset.dbg%.o : drivers/net/ath5k/ath5k_reset.c $(MAKEDEPS) $(POST_O_DEPS) $(ath5k_reset_DEPS) 
	$(QM)echo "  [BUILD] $@" 
	$(RULE_c_to_dbg%.o)
 
dbg%.o_OBJS += $(BIN)/ath5k_reset.dbg%.o
 
$(BIN)/ath5k_reset.c : drivers/net/ath5k/ath5k_reset.c $(MAKEDEPS) $(POST_O_DEPS) $(ath5k_reset_DEPS) 
	$(QM)echo "  [BUILD] $@" 
	$(RULE_c_to_c)
 
c_OBJS += $(BIN)/ath5k_reset.c
 
$(BIN)/ath5k_reset.s : drivers/net/ath5k/ath5k_reset.c $(MAKEDEPS) $(POST_O_DEPS) $(ath5k_reset_DEPS) 
	$(QM)echo "  [BUILD] $@" 
	$(RULE_c_to_s)
 
s_OBJS += $(BIN)/ath5k_reset.s
 
bin/deps/drivers/net/ath5k/ath5k_reset.c.d : $(ath5k_reset_DEPS)
 
TAGS : $(ath5k_reset_DEPS)
