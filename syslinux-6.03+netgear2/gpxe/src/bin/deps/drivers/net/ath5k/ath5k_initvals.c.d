ath5k_initvals_DEPS = drivers/net/ath5k/ath5k_initvals.c include/compiler.h \
 ...
 include/little_bswap.h include/gpxe/io.h config/ioapi.h \
...
$(BIN)/ath5k_initvals.o : drivers/net/ath5k/ath5k_initvals.c $(MAKEDEPS) $(POST_O_DEPS) $(ath5k_initvals_DEPS) 
	$(QM)echo "  [BUILD] $@" 
	$(RULE_c)
 
BOBJS += $(BIN)/ath5k_initvals.o
 
$(BIN)/ath5k_initvals.dbg%.o : drivers/net/ath5k/ath5k_initvals.c $(MAKEDEPS) $(POST_O_DEPS) $(ath5k_initvals_DEPS) 
	$(QM)echo "  [BUILD] $@" 
	$(RULE_c_to_dbg%.o)
 
dbg%.o_OBJS += $(BIN)/ath5k_initvals.dbg%.o
 
$(BIN)/ath5k_initvals.c : drivers/net/ath5k/ath5k_initvals.c $(MAKEDEPS) $(POST_O_DEPS) $(ath5k_initvals_DEPS) 
	$(QM)echo "  [BUILD] $@" 
	$(RULE_c_to_c)
 
c_OBJS += $(BIN)/ath5k_initvals.c
 
$(BIN)/ath5k_initvals.s : drivers/net/ath5k/ath5k_initvals.c $(MAKEDEPS) $(POST_O_DEPS) $(ath5k_initvals_DEPS) 
	$(QM)echo "  [BUILD] $@" 
	$(RULE_c_to_s)
 
s_OBJS += $(BIN)/ath5k_initvals.s
 
bin/deps/drivers/net/ath5k/ath5k_initvals.c.d : $(ath5k_initvals_DEPS)
 
TAGS : $(ath5k_initvals_DEPS)
