ath5k_qcu_DEPS = drivers/net/ath5k/ath5k_qcu.c include/compiler.h \
...
$(BIN)/ath5k_qcu.o : drivers/net/ath5k/ath5k_qcu.c $(MAKEDEPS) $(POST_O_DEPS) $(ath5k_qcu_DEPS) 
	$(QM)echo "  [BUILD] $@" 
	$(RULE_c)
 
BOBJS += $(BIN)/ath5k_qcu.o
 
$(BIN)/ath5k_qcu.dbg%.o : drivers/net/ath5k/ath5k_qcu.c $(MAKEDEPS) $(POST_O_DEPS) $(ath5k_qcu_DEPS) 
	$(QM)echo "  [BUILD] $@" 
	$(RULE_c_to_dbg%.o)
 
dbg%.o_OBJS += $(BIN)/ath5k_qcu.dbg%.o
 
$(BIN)/ath5k_qcu.c : drivers/net/ath5k/ath5k_qcu.c $(MAKEDEPS) $(POST_O_DEPS) $(ath5k_qcu_DEPS) 
	$(QM)echo "  [BUILD] $@" 
	$(RULE_c_to_c)
 
c_OBJS += $(BIN)/ath5k_qcu.c
 
$(BIN)/ath5k_qcu.s : drivers/net/ath5k/ath5k_qcu.c $(MAKEDEPS) $(POST_O_DEPS) $(ath5k_qcu_DEPS) 
	$(QM)echo "  [BUILD] $@" 
	$(RULE_c_to_s)
 
s_OBJS += $(BIN)/ath5k_qcu.s
 
bin/deps/drivers/net/ath5k/ath5k_qcu.c.d : $(ath5k_qcu_DEPS)
