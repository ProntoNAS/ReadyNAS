ath5k_desc_DEPS = drivers/net/ath5k/ath5k_desc.c include/compiler.h \
...
$(BIN)/ath5k_desc.o : drivers/net/ath5k/ath5k_desc.c $(MAKEDEPS) $(POST_O_DEPS) $(ath5k_desc_DEPS) 
	$(QM)echo "  [BUILD] $@" 
	$(RULE_c)
 
BOBJS += $(BIN)/ath5k_desc.o
 
$(BIN)/ath5k_desc.dbg%.o : drivers/net/ath5k/ath5k_desc.c $(MAKEDEPS) $(POST_O_DEPS) $(ath5k_desc_DEPS) 
	$(QM)echo "  [BUILD] $@" 
	$(RULE_c_to_dbg%.o)
 
dbg%.o_OBJS += $(BIN)/ath5k_desc.dbg%.o
 
$(BIN)/ath5k_desc.c : drivers/net/ath5k/ath5k_desc.c $(MAKEDEPS) $(POST_O_DEPS) $(ath5k_desc_DEPS) 
	$(QM)echo "  [BUILD] $@" 
	$(RULE_c_to_c)
 
c_OBJS += $(BIN)/ath5k_desc.c
 
$(BIN)/ath5k_desc.s : drivers/net/ath5k/ath5k_desc.c $(MAKEDEPS) $(POST_O_DEPS) $(ath5k_desc_DEPS) 
	$(QM)echo "  [BUILD] $@" 
	$(RULE_c_to_s)
 
s_OBJS += $(BIN)/ath5k_desc.s
 
bin/deps/drivers/net/ath5k/ath5k_desc.c.d : $(ath5k_desc_DEPS)
 
TAGS : $(ath5k_desc_DEPS)
