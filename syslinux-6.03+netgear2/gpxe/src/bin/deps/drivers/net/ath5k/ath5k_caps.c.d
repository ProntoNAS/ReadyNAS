ath5k_caps_DEPS = drivers/net/ath5k/ath5k_caps.c include/compiler.h \
...
$(BIN)/ath5k_caps.o : drivers/net/ath5k/ath5k_caps.c $(MAKEDEPS) $(POST_O_DEPS) $(ath5k_caps_DEPS) 
	$(QM)echo "  [BUILD] $@" 
	$(RULE_c)
 
BOBJS += $(BIN)/ath5k_caps.o
 
$(BIN)/ath5k_caps.dbg%.o : drivers/net/ath5k/ath5k_caps.c $(MAKEDEPS) $(POST_O_DEPS) $(ath5k_caps_DEPS) 
	$(QM)echo "  [BUILD] $@" 
	$(RULE_c_to_dbg%.o)
 
dbg%.o_OBJS += $(BIN)/ath5k_caps.dbg%.o
 
$(BIN)/ath5k_caps.c : drivers/net/ath5k/ath5k_caps.c $(MAKEDEPS) $(POST_O_DEPS) $(ath5k_caps_DEPS) 
	$(QM)echo "  [BUILD] $@" 
	$(RULE_c_to_c)
 
c_OBJS += $(BIN)/ath5k_caps.c
 
$(BIN)/ath5k_caps.s : drivers/net/ath5k/ath5k_caps.c $(MAKEDEPS) $(POST_O_DEPS) $(ath5k_caps_DEPS) 
	$(QM)echo "  [BUILD] $@" 
	$(RULE_c_to_s)
 
s_OBJS += $(BIN)/ath5k_caps.s
 
bin/deps/drivers/net/ath5k/ath5k_caps.c.d : $(ath5k_caps_DEPS)
 
TAGS : $(ath5k_caps_DEPS)
