ath5k_pcu_DEPS = drivers/net/ath5k/ath5k_pcu.c include/compiler.h \
...
$(BIN)/ath5k_pcu.o : drivers/net/ath5k/ath5k_pcu.c $(MAKEDEPS) $(POST_O_DEPS) $(ath5k_pcu_DEPS) 
	$(QM)echo "  [BUILD] $@" 
	$(RULE_c)
 
BOBJS += $(BIN)/ath5k_pcu.o
 
$(BIN)/ath5k_pcu.dbg%.o : drivers/net/ath5k/ath5k_pcu.c $(MAKEDEPS) $(POST_O_DEPS) $(ath5k_pcu_DEPS) 
	$(QM)echo "  [BUILD] $@" 
	$(RULE_c_to_dbg%.o)
 
dbg%.o_OBJS += $(BIN)/ath5k_pcu.dbg%.o
 
$(BIN)/ath5k_pcu.c : drivers/net/ath5k/ath5k_pcu.c $(MAKEDEPS) $(POST_O_DEPS) $(ath5k_pcu_DEPS) 
	$(QM)echo "  [BUILD] $@" 
	$(RULE_c_to_c)
 
c_OBJS += $(BIN)/ath5k_pcu.c
 
$(BIN)/ath5k_pcu.s : drivers/net/ath5k/ath5k_pcu.c $(MAKEDEPS) $(POST_O_DEPS) $(ath5k_pcu_DEPS) 
	$(QM)echo "  [BUILD] $@" 
	$(RULE_c_to_s)
 
s_OBJS += $(BIN)/ath5k_pcu.s
 
bin/deps/drivers/net/ath5k/ath5k_pcu.c.d : $(ath5k_pcu_DEPS)
