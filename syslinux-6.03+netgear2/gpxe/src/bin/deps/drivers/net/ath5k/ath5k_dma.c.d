ath5k_dma_DEPS = drivers/net/ath5k/ath5k_dma.c include/compiler.h \
...
$(BIN)/ath5k_dma.o : drivers/net/ath5k/ath5k_dma.c $(MAKEDEPS) $(POST_O_DEPS) $(ath5k_dma_DEPS) 
	$(QM)echo "  [BUILD] $@" 
	$(RULE_c)
 
BOBJS += $(BIN)/ath5k_dma.o
 
$(BIN)/ath5k_dma.dbg%.o : drivers/net/ath5k/ath5k_dma.c $(MAKEDEPS) $(POST_O_DEPS) $(ath5k_dma_DEPS) 
	$(QM)echo "  [BUILD] $@" 
	$(RULE_c_to_dbg%.o)
 
dbg%.o_OBJS += $(BIN)/ath5k_dma.dbg%.o
 
$(BIN)/ath5k_dma.c : drivers/net/ath5k/ath5k_dma.c $(MAKEDEPS) $(POST_O_DEPS) $(ath5k_dma_DEPS) 
	$(QM)echo "  [BUILD] $@" 
	$(RULE_c_to_c)
 
c_OBJS += $(BIN)/ath5k_dma.c
 
$(BIN)/ath5k_dma.s : drivers/net/ath5k/ath5k_dma.c $(MAKEDEPS) $(POST_O_DEPS) $(ath5k_dma_DEPS) 
	$(QM)echo "  [BUILD] $@" 
	$(RULE_c_to_s)
 
s_OBJS += $(BIN)/ath5k_dma.s
 
bin/deps/drivers/net/ath5k/ath5k_dma.c.d : $(ath5k_dma_DEPS)
