...
#include "APR/Request/APR__Request.h"
...
apr_size_t
apreq_cp1252_to_utf8(dest, src, slen)
    char * dest
    const char * src
    apr_size_t slen
...
BOOT:
   ...
   cv = newXS("APR::Request::Param::Table::FIRSTKEY", apreq_xs_param_table_NEXTKEY, __FILE__);
   cv = newXS("APR::Request::Cookie::Table::NEXTKEY", apreq_xs_cookie_table_NEXTKEY, __FILE__);
   cv = newXS("APR::Request::Param::Table::get", apreq_xs_param_table_FETCH, __FILE__);
   cv = newXS("APR::Request::body", apreq_xs_body, __FILE__);
   cv = newXS("APR::Request::Cookie::Table::FETCH", apreq_xs_cookie_table_FETCH, __FILE__);
   cv = newXS("APR::Request::Cookie::Table::FIRSTKEY", apreq_xs_cookie_table_NEXTKEY, __FILE__);
   cv = newXS("APR::Request::param", apreq_xs_param, __FILE__);
   cv = newXS("APR::Request::jar", apreq_xs_jar, __FILE__);
   cv = newXS("APR::Request::parse", apreq_xs_parse, __FILE__);
   cv = newXS("APR::Request::Cookie::Table::get", apreq_xs_cookie_table_FETCH, __FILE__);
   cv = newXS("APR::Request::Param::Table::FETCH", apreq_xs_param_table_FETCH, __FILE__);
   cv = newXS("APR::Request::args", apreq_xs_args, __FILE__);
   cv = newXS("APR::Request::Cookie::Table::do", apreq_xs_cookie_table_do, __FILE__);
   cv = newXS("APR::Request::Param::Table::do", apreq_xs_param_table_do, __FILE__);
   cv = newXS("APR::Request::Param::Table::NEXTKEY", apreq_xs_param_table_NEXTKEY, __FILE__);
