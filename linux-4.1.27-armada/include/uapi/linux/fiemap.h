...
struct fiemap_extent {
	...
	__u32 fe_pdev;	   /* physical dev_t if FIEMAP_EXTENT_PHYSICAL
			      or 32bit checksum for FIEMAP_EXTENT_CHECKSUM */
};

#define fe_checksum	fe_pdev
...
#define FIEMAP_FLAG_CHECKSUM	0x40000000 /* report block checksums */
...
#define FIEMAP_EXTENT_SHARED		0x00002000 /* Space shared with other
						    * files. */
#define FIEMAP_EXTENT_CHECKSUM		0x00800000 /* This extent represents
						    * block checksum */
