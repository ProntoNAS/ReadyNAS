...
static const struct pinctrl_pin_desc spth_pins[] = {
	...
	/* GPD */
	PINCTRL_PIN(192, "BATLOW#"),
	PINCTRL_PIN(193, "ACPRESENT"),
	PINCTRL_PIN(194, "LAN_WAKE#"),
	PINCTRL_PIN(195, "PWRBTN#"),
	PINCTRL_PIN(196, "SLP_S3#"),
	PINCTRL_PIN(197, "SLP_S4#"),
	PINCTRL_PIN(198, "SLP_A#"),
	PINCTRL_PIN(199, "reserved"),
	PINCTRL_PIN(200, "SUSCLK"),
	PINCTRL_PIN(201, "SLK_WLAN#"),
	PINCTRL_PIN(202, "SLP_S5#"),
	PINCTRL_PIN(203, "LANPHPC"),
};
