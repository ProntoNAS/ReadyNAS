...
{
	switch (val) {
	case BOOT_DEVICE_NOR_8BIT:
		return "8 bit NOR Flash";
		break;
	case BOOT_DEVICE_NOR_16BIT:
		return "16 bit NOR Flash";
		break;
	case BOOT_DEVICE_NAND_8BIT:
		return "8 bit NAND Flash";
		break;
	case BOOT_DEVICE_NAND_16BIT:
		return "16 bit NAND Flash";
		break;
