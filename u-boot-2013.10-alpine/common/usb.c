...
/*
 * XHCI issues Reset Endpoint command and thereafter
 * update device contexts. Provide a weak alias
 * function for the purpose, so that XHCI overrides it
 * and EHCI/OHCI just work out of the box.
 */
__weak void usb_reset_endpoint(struct usb_device *dev, int pipe)
{
	/*
