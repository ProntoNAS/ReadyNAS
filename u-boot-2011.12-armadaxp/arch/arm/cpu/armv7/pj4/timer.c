...
#define TIMER_INIT_DONE		0x1
static ulong timestamp=1;
static ulong lastdec=1;
static int timer_init_done=TIMER_INIT_VALUE;
...
int timer_init (void)
{
	...
	if (timer_init_done == TIMER_INIT_DONE)
		return 0;
	...
	timer_init_done = TIMER_INIT_DONE;
