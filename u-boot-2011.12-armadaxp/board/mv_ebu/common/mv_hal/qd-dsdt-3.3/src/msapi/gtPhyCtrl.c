...
)
{
	...
	retVal = hwWritePagedPhyRegField(dev, hwPort, 2, QD_PHY_GE_LINE_LOOPBACK_REG, 14, 1, phyInfo.anyPage, u16Data);
...
)
{
	...
	retVal = hwReadPagedPhyRegField(dev, hwPort, 2, QD_PHY_GE_LINE_LOOPBACK_REG, 14, 1, phyInfo.anyPage, &u16Data);
...
)
{
    ...
    {
	u16Data = u16Data & (QD_PHY_SPEED_MSB | QD_PHY_SPEED | QD_PHY_DUPLEX);
    }
