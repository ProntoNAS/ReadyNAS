...
clcd.lcd0_enable=$lcd0_enable clcd.lcd_panel=$lcd_panel; bootz 0x2000000 - $fdtaddr;";
	...
	if(!env)
		...
		setenv("bootcmd", "nand read 0x2000000 0x200000 0x400000; nand read 0x3000000 0x800000 0x400000; nand read 0x1000000 0xEC000 0x6000; bootm 0x2000000 0x3000000 0x1000000");
