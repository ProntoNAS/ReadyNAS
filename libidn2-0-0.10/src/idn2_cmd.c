/*
  ...
  gengetopt --unamed-opts --no-handle-version --no-handle-help --set-package=idn2 --input idn2.ggo --file-name idn2_cmd Makefile.am 
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->lookup_help = gengetopt_args_info_help[2] ;
  args_info->register_help = gengetopt_args_info_help[3] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVlr", long_options, &option_index);
