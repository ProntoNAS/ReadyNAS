...
#if 0
/* hiro.sugawara@netgear.com - PMBUS_CAPABILITY response is not reliable.
   Actual PSU may expect PEC for receiving (host->PSU) but may not add PEC
   for sending (PSU->host).
   This new code added between Linux Kernel 4.2 and 4.4 kills the entire
   I2C bus on ReadyNAS platforms RR4312/4360. So, disabling it.
   This one-way PEC is handled by the I2C_CLIENT_PEC_PMBUS_WRITE_ONLY
   patch.
*/
