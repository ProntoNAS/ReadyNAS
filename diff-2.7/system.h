...
#ifndef same_file
/*
Raul Miller, Sat Jun  6 22:10:54 EDT 1998
fstat not reliable with ncpfs as inode is reused after file close
#define same_file(s,t) ((s)->st_ino==(t)->st_ino && (s)->st_dev==(t)->st_dev)
*/
#include <stdio.h>
#define same_file_workaround(s,t) (\
  ((s)->st_size==(t)->st_size && (s)->st_mtime==(t)->st_mtime && \
    (s)->st_ctime==(t)->st_ctime)  ? 1 \
      : (fputs("Warning: race condition or ncpfs fstat bug detected\n", stderr), 0))

#define same_file(s,t) ((s)->st_ino==(t)->st_ino && (s)->st_dev==(t)->st_dev \
  && same_file_workaround(s,t))
#endif
