 ...
 *
 *	$Log: skcsum.c,v $
 *	Revision 2.4  2007/03/14 16:20:40  rassmann
 *	Updated IPv6 header parsing in RX path.
 *
 *	Revision 2.3  2007/02/16 13:06:33  rassmann
 *	Merged changes from Windows Yukon-Extreme branch:
 *	- Moved defines for IP header length to header file.
 *	- Check frame length before accessing the buffer in SkCsGetReceiveInfo.
 *	- Corrected handling of malformed frames in SkCsGetReceiveInfo.
 *	- SkCsGetReceiveInfo(): Packets with unknown IPv6 headers are returned as "not checkable".
 *	Editorial changes.
 *
 *	Revision 2.2  2005/12/14 16:11:26  ibrueder
...
static const char SysKonnectFileId[] =
	"@(#) $Id: //Release/Yukon_1G/Shared/csum/V5/skcsum.c#3 $ (C) SysKonnect.";
#endif	/* !lint */
