...
static void igb_config_collision_dist_generic(struct e1000_hw *hw);
 ...
 **/
s32 igb_get_speed_and_duplex_fiber_serdes_generic(struct e1000_hw E1000_UNUSEDARG *hw,
...
/**
 *  igb_validate_mdi_setting_crossover_generic - Verify MDI/MDIx settings
 *  @hw: pointer to the HW structure
 *
 *  Validate the MDI/MDIx setting, allowing for auto-crossover during forced
 *  operation.
 **/
s32 igb_validate_mdi_setting_crossover_generic(struct e1000_hw E1000_UNUSEDARG *hw)
{
	DEBUGFUNC("igb_validate_mdi_setting_crossover_generic");
